...
public class StructDefinition extends DualNode {
	...
	static int method4952(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.CC_SETTRANS) {
			var4.transparencyTop = Interpreter.Interpreter_intStack[--RouteStrategy.Interpreter_intStackSize];
			WorldMapRectangle.method295(var4);
			return 1;
		}
		...
		if (var0 == ScriptOpcodes.CC_SETSCROLLSIZE) {
			...
			if (var3 != -1 && var4.type == 0) {
				WorldMapData_1.revalidateWidgetScroll(Widget.Widget_interfaceComponents[var3 >> 16], var4, false);
			}
		...
		if (var0 == ScriptOpcodes.CC_SETTRANSBOT) {
			var4.transparencyBot = Interpreter.Interpreter_intStack[--RouteStrategy.Interpreter_intStackSize];
			WorldMapRectangle.method295(var4);
			return 1;
		}
		if (var0 == ScriptOpcodes.CC_SETFILLMODE) {
			var5 = Interpreter.Interpreter_intStack[--RouteStrategy.Interpreter_intStackSize];
			FillMode var7 = (FillMode)ScriptFrame.findEnumerated(DefaultsGroup.method5822(), var5);
			if (var7 != null) {
				var4.fillMode = var7;
				WorldMapRectangle.method295(var4);
			}
