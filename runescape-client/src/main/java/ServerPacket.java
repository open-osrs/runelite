...
public class ServerPacket {
	...
	@Export("SpriteBuffer_createIndexedSprite")
	static IndexedSprite SpriteBuffer_createIndexedSprite() {
		IndexedSprite var0 = new IndexedSprite();
		var0.width = SpriteBuffer.SpriteBuffer_spriteWidth;
		var0.height = SpriteBuffer.SpriteBuffer_spriteHeight;
		var0.xOffset = SpriteBuffer.SpriteBuffer_xOffsets[0];
		var0.yOffset = SpriteBuffer.SpriteBuffer_yOffsets[0];
		...
		var0.palette = SpriteBuffer.SpriteBuffer_spritePalette;
		var0.pixels = SpriteBuffer.SpriteBuffer_pixels[0];
