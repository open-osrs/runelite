...
public class WorldMapRegion {
   ...
   void method506(int var1, int var2, int var3) {
      Sprite var4 = LoginPacket.method3816(this.regionX, this.regionY, this.pixelsPerTile);
      if (var4 != null) {
            ...
            for(int var8 = 0; var8 < var5.planes; ++var8) {
               ...
               if (var9 != null && var9.length != 0) {
                  ...
                  for(int var11 = 0; var11 < var10.length; ++var11) {
                     ...
                     ObjectDefinition var13 = WorldMapAreaData.getObjectDefinition(var12.objectDefinitionId);
      ...
      for(int var5 = 0; var5 < var3.planes; ++var5) {
         ...
         if (var6 != null && var6.length != 0) {
            ...
            for(int var8 = 0; var8 < var7.length; ++var8) {
               ...
               ObjectDefinition var14 = WorldMapAreaData.getObjectDefinition(var9.objectDefinitionId);
         ...
         if (var5 != null && var5.length != 0) {
            ...
            for(int var7 = 0; var7 < var6.length; ++var7) {
               ...
               if (GraphicsObject.method2153(var8.decoration)) {
                  ObjectDefinition var9 = WorldMapAreaData.getObjectDefinition(var8.objectDefinitionId);
   ...
   int method577(Sprite var1, HorizontalAlignment var2) {
      switch(var2.value) {
      case 0:
         return 0;
      case 2:
   ...
   int method534(Sprite var1, VerticalAlignment var2) {
      switch(var2.value) {
      case 0:
         return 0;
      case 2:
