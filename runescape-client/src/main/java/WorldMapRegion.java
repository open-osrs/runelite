...
public class WorldMapRegion {
      ...
      void getIcon(ObjectDefinition var1, int var2, int var3, int var4, AbstractWorldMapData var5) {
            ...
            if (var1.transforms != null) {
                  var10 = new WorldMapIcon_1(var7, var6, var1.field_14, this);
            } else {
                        ...
                        for(int var7 = 0; var7 < var6.length; ++var7) {
                              ...
                              if (var9) {
                                    ...
                                    if (var8.decoration == WorldMapDecorationType.field2702.field_49) {
                                          ...
                                          if (var8.rotation == 1) {
                                                Rasterizer2D.method5935(this.pixelsPerTile * var1 + this.pixelsPerTile - 1, this.pixelsPerTile * (63 - var2), 1, var12);
                                          }

                                          if (var8.rotation == 2) {
                                                Rasterizer2D.method5935(this.pixelsPerTile + this.pixelsPerTile * var1 - 1, this.pixelsPerTile * (63 - var2) + this.pixelsPerTile - 1, 1, var12);
                                          }

                                          if (var8.rotation == 3) {
                                                Rasterizer2D.method5935(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2) + this.pixelsPerTile - 1, 1, var12);
                                          }
                                    }
                                    ...
                                    if (var8.decoration == WorldMapDecorationType.field2708.field_49) {
                                          ...
                                          if (var13 == 0) {
                                                for(var14 = 0; var14 < this.pixelsPerTile; ++var14) {
                                                      Rasterizer2D.method5935(var14 + this.pixelsPerTile * var1, (64 - var2) * this.pixelsPerTile - 1 - var14, 1, var12);
                                                }
                                          } else {
                                                for(var14 = 0; var14 < this.pixelsPerTile; ++var14) {
                                                      Rasterizer2D.method5935(var14 + this.pixelsPerTile * var1, var14 + this.pixelsPerTile * (63 - var2), 1, var12);
                                                }
                                          }
                                    }
                              }
      ...
      void method474(int var1, int var2, int var3, int var4) {
            var3 %= 4;
            if (var3 == 0) {
                  Rasterizer2D.method5937(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2), this.pixelsPerTile, var4);
            }

            if (var3 == 1) {
                  Rasterizer2D.method5935(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2), this.pixelsPerTile, var4);
            }

            if (var3 == 2) {
                  Rasterizer2D.method5937(this.pixelsPerTile * var1 + this.pixelsPerTile - 1, this.pixelsPerTile * (63 - var2), this.pixelsPerTile, var4);
            }

            if (var3 == 3) {
                  Rasterizer2D.method5935(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2) + this.pixelsPerTile - 1, this.pixelsPerTile, var4);
            }
