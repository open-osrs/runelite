...
public class class248 {
	...
	public final void method4720(int var1, int var2, Sprite var3, float var4) {
		...
		for (var10 = 0; var10 < this.field3266; ++var10) {
			...
			this.bounds.method30(var8, var9);
	...
	static int method4741(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.TRADINGPOST_SORTBY_NAME) {
			...
			if (FloorDecoration.grandExchangeEvents != null) {
				FloorDecoration.grandExchangeEvents.sort(GrandExchangeEvents.GrandExchangeEvents_nameComparator, var5);
			}
		...
		if (var0 == ScriptOpcodes.TRADINGPOST_SORTBY_PRICE) {
			var5 = Interpreter.Interpreter_intStack[--RouteStrategy.Interpreter_intStackSize] == 1;
			if (FloorDecoration.grandExchangeEvents != null) {
				FloorDecoration.grandExchangeEvents.sort(GrandExchangeEvents.GrandExchangeEvents_priceComparator, var5);
			}
		...
		if (var0 == ScriptOpcodes.TRADINGPOST_SORTFILTERBY_WORLD) {
			...
			if (FloorDecoration.grandExchangeEvents != null) {
				...
				FloorDecoration.grandExchangeEvents.sort(Client.GrandExchangeEvents_worldComparator, var5);
			}
		...
		if (var0 == ScriptOpcodes.TRADINGPOST_SORTBY_AGE) {
			var5 = Interpreter.Interpreter_intStack[--RouteStrategy.Interpreter_intStackSize] == 1;
			if (FloorDecoration.grandExchangeEvents != null) {
				FloorDecoration.grandExchangeEvents.sort(GrandExchangeEvents.GrandExchangeEvents_ageComparator, var5);
			}
		...
		if (var0 == ScriptOpcodes.TRADINGPOST_SORTBY_COUNT) {
			var5 = Interpreter.Interpreter_intStack[--RouteStrategy.Interpreter_intStackSize] == 1;
			if (FloorDecoration.grandExchangeEvents != null) {
				FloorDecoration.grandExchangeEvents.sort(GrandExchangeEvents.GrandExchangeEvents_quantityComparator, var5);
			}
		...
		if (var0 == ScriptOpcodes.TRADINGPOST_GETOFFERAGE) {
			var3 = Interpreter.Interpreter_intStack[--RouteStrategy.Interpreter_intStackSize];
			var6 = (GrandExchangeEvent)FloorDecoration.grandExchangeEvents.events.get(var3);
			long var7 = class203.currentTimeMs() - WorldMapData_0.field1113 - var6.age;
