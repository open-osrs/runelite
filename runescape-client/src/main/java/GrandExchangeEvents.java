...
public class GrandExchangeEvents {
	...
	@Export("HitSplatDefinition_clearCached")
	public static void HitSplatDefinition_clearCached() {
	...
	static int method75(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.IF_GETTRANSTOP) {
			Interpreter.Interpreter_intStack[++RouteStrategy.Interpreter_intStackSize - 1] = var3.transparencyTop;
			return 1;
		}
		if (var0 == ScriptOpcodes.IF_GETTRANSBOT) {
			Interpreter.Interpreter_intStack[++RouteStrategy.Interpreter_intStackSize - 1] = var3.transparencyBot;
			return 1;
		}
		...
		if (var0 == ScriptOpcodes.IF_GETFILLMODE) {
			Interpreter.Interpreter_intStack[++RouteStrategy.Interpreter_intStackSize - 1] = var3.fillMode.rsOrdinal();
			return 1;
		}
	...
	static final void method74(int var0, int var1) {
		if (GroundItemPile.loadInterface(var0)) {
			class30.method570(Widget.Widget_interfaceComponents[var0], var1);
		}
