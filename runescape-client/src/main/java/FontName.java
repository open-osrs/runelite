			...
			if (var10 != null && (var10.parentId == var1 || var1 == -1412584499 && var10 == Client.clickedWidget)) {
				...
				if (!var10.isIf3 || !DevicePcmPlayerProvider.isComponentHidden(var10)) {
					...
					if (!var10.isIf3 || var15 < var17 && var16 < var18) {
						if (var10.contentType != 0) {
							if (var10.contentType == 1336) {
								if (Client.displayFps) {
									var13 += 15;
									WorldMapLabelSize.fontPlain12.drawRightAligned("Fps:" + GameShell.fps, var12 + var10.width, var13, 16776960, -1);
									var13 += 15;
						...
						if (var10.type == 0) {
							if (!var10.isIf3 && DevicePcmPlayerProvider.isComponentHidden(var10) && var10 != EnumDefinition.mousedOverWidgetIf1) {
								continue;
							}
							...
							if (var10.type != 1) {
								...
								if (var10.type == 2) {
									...
									for (var20 = 0; var20 < var10.rawHeight; ++var20) {
										for (var21 = 0; var21 < var10.rawWidth; ++var21) {
											...
											if (var10.itemIds[var19] <= 0) {
												...
												if (var22 + 32 > var2 && var22 < var4 && var23 + 32 > var3 && var23 < var5 || var10 == class171.dragInventoryWidget && var19 == Client.dragItemSlotSource) {
													Sprite var35;
													if (Client.isItemSelected == 1 && var19 == ChatChannel.selectedItemSlot && var10.id == WorldMapLabelSize.selectedItemWidget) {
														var35 = WorldMapManager.getItemSprite(var26, var10.itemQuantities[var19], 2, 0, 2, false);
													} else {
														var35 = WorldMapManager.getItemSprite(var26, var10.itemQuantities[var19], 1, 3153952, 2, false);
													}

													if (var35 != null) {
														if (var10 == class171.dragInventoryWidget && var19 == Client.dragItemSlotSource) {
														...
														} else if (var10 == NPC.field1131 && var19 == Client.field881) {
									...
									if (class8.runCs1(var10)) {
										var19 = var10.color2;
										if (var10 == EnumDefinition.mousedOverWidgetIf1 && var10.mouseOverColor2 != 0) {
											var19 = var10.mouseOverColor2;
										}
									} else {
										var19 = var10.color;
										if (var10 == EnumDefinition.mousedOverWidgetIf1 && var10.mouseOverColor != 0) {
									...
									if (var10.type == 4) {
										...
										if (var39 == null) {
											...
											if (var10.isIf3 && var10.itemId != -1) {
												ItemDefinition var45 = SecureRandomCallable.ItemDefinition_get(var10.itemId);
												var44 = var45.name;
												if (var44 == null) {
													var44 = "null";
												}
										...
										Sprite var40;
										if (!var10.isIf3) {
											var40 = var10.getSprite(class8.runCs1(var10));
											if (var40 != null) {
										...
										if (var10.type == 6) {
											boolean var36 = class8.runCs1(var10);
											if (var36) {
											...
											var22 = 0;
											if (var10.itemId != -1) {
												var33 = SecureRandomCallable.ItemDefinition_get(var10.itemId);
												if (var33 != null) {
												...
												if (var10.modelId == 0) {
													...
													var41 = PlayerAppearance.localPlayer.getModel();
												}
											} else if (var20 == -1) {
												var41 = var10.getModel((SequenceDefinition)null, -1, var36, PlayerAppearance.localPlayer.appearance);
												if (var41 == null && Widget.field2603) {
													CollisionMap.invalidateWidget(var10);
												}
											} else {
												SequenceDefinition var47 = ParamDefinition.SequenceDefinition_get(var20);
												var41 = var10.getModel(var47, var10.modelFrame, var36, PlayerAppearance.localPlayer.appearance);
												if (var41 == null && Widget.field2603) {
													CollisionMap.invalidateWidget(var10);
												}
											}
											...
											if (var41 != null) {
												if (!var10.isIf3) {
													...
													if (var10.modelOrthog) {
														...
														var41.method2966(0, var10.modelAngleY, var10.modelAngleZ, var10.modelAngleX, var10.modelOffsetX, var22 + var23 + var10.modelOffsetY, var24 + var10.modelOffsetY);
													}
												}
											}
												...
												for (var21 = 0; var21 < var10.rawHeight; ++var21) {
													for (var22 = 0; var22 < var10.rawWidth; ++var22) {
														if (var10.itemIds[var20] > 0) {
															var33 = SecureRandomCallable.ItemDefinition_get(var10.itemIds[var20] - 1);
															String var34;
															if (var33.isStackable != 1 && var10.itemQuantities[var20] == 1) {
																var34 = class23.colorStartTag(16748608) + var33.name + "</col>";
															} else {
											...
											if (var10.type == 9) {
												...
												if (var10.lineWid == 1) {
													...
													class7.method87(var19, var20, var21, var22, var10.color, var10.lineWid);
												}
											}
										}
									}
