...
public class Texture extends Node {
	...
	Texture(Buffer var1) {
		...
		if (var2 >= 1 && var2 <= 4) { // L: 32
			...
			if (var2 > 1) { // L: 37
				this.field2278 = new int[var2 - 1]; // L: 38
			...
			if (var2 > 1) { // L: 41
				this.field2279 = new int[var2 - 1]; // L: 42
			...
			this.field2280 = new int[var2]; // L: 45
	...
	boolean load(double var1, int var3, AbstractArchive var4) {
		...
		for (int var6 = 0; var6 < this.fileIds.length; ++var6) { // L: 58
			IndexedSprite var7 = GameBuild.method5774(var4, this.fileIds[var6]); // L: 59
			var7.normalize(); // L: 60
			byte[] var8 = var7.pixels; // L: 61
			int[] var9 = var7.palette; // L: 62
			int var10 = this.field2280[var6]; // L: 63
			...
			if (var6 == 0) { // L: 79
				...
				var11 = this.field2278[var6 - 1]; // L: 80
			}
