...
public class WorldMapCacheName {
      ...
      public static final WorldMapCacheName field284 = new WorldMapCacheName("details");
      @ObfuscatedName("n")
      @ObfuscatedSignature(
            signature = "Lao;"
      )
      public static final WorldMapCacheName field289 = new WorldMapCacheName("compositemap");
      @ObfuscatedName("v")
      @ObfuscatedSignature(
            signature = "Lao;"
      )
      public static final WorldMapCacheName field283 = new WorldMapCacheName("compositetexture");
      @ObfuscatedName("u")
      @ObfuscatedSignature(
            signature = "Lao;"
      )
      static final WorldMapCacheName field285 = new WorldMapCacheName("area");
      @ObfuscatedName("r")
      @ObfuscatedSignature(
            signature = "Lao;"
      )
      public static final WorldMapCacheName field287 = new WorldMapCacheName("labels");
      @ObfuscatedName("ay")
      @ObfuscatedGetter(
            intValue = 1366497929
      )
      ...
      static final void updateItemPile(int var0, int var1) {
            ...
            if (var2 == null) {
                  ...
                  for(var6 = (TileItem)var2.last(); var6 != null; var6 = (TileItem)var2.previous()) {
                        ItemDefinition var7 = Occluder.ItemDefinition_get(var6.field_23);
                  ...
                  if (var5 == null) {
                        ...
                        for(var6 = (TileItem)var2.last(); var6 != null; var6 = (TileItem)var2.previous()) {
                              if (var5.field_23 != var6.field_23) {
                                    if (var12 == null) {
                                          var12 = var6;
                                    }

                                    if (var6.field_23 != var12.field_23 && var11 == null) {
                                          var11 = var6;
                                    }
                              }
                        }
