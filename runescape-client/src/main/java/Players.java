            ...
            if (var0 != null && var0.isVisible() && !var0.isHidden) {
                  ...
                  if (var2 >= 0 && var2 < 104 && var3 >= 0 && var3 < 104) {
                        ...
                        if (var0.model0 != null && Client.cycle >= var0.animationCycleStart && Client.cycle < var0.animationCycleEnd) {
                              var0.isUnanimated = false;
                              var0.tileHeight = MusicPatchPcmStream.getTileHeight(var0.field_27, var0.field_28, WorldMapRectangle.plane);
                              var0.playerCycle = Client.cycle;
                              PacketWriter.scene.addNullableObject(WorldMapRectangle.plane, var0.field_27, var0.field_28, var0.tileHeight, 60, var0, var0.rotation, var4, var0.field622, var0.field611, var0.field612, var0.field613);
                        } else {
                              ...
                              var0.tileHeight = MusicPatchPcmStream.getTileHeight(var0.field_27, var0.field_28, WorldMapRectangle.plane);
                              var0.playerCycle = Client.cycle;
                              PacketWriter.scene.drawEntity(WorldMapRectangle.plane, var0.field_27, var0.field_28, var0.tileHeight, 60, var0, var0.rotation, var4, var0.isWalking);
                        }
                  }
            }
