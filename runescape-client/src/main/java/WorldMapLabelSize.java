   ...
   static final boolean method254(Widget var0) {
      ...
      if (var1 == 205) {
         ...
         if (var1 >= 300 && var1 <= 313) {
            var2 = (var1 - 300) / 2;
            var3 = var1 & 1;
            Client.playerComposition.changeAppearance(var2, var3 == 1);
         }

         if (var1 >= 314 && var1 <= 323) {
            var2 = (var1 - 314) / 2;
            var3 = var1 & 1;
            Client.playerComposition.method4206(var2, var3 == 1);
         }

         if (var1 == 324) {
            Client.playerComposition.changeSex(false);
         }
         ...
         if (var1 == 326) {
            ...
            Client.playerComposition.write(var4.packetBuffer);
