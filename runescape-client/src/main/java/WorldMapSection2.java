...
public class WorldMapSection2 implements WorldMapSection {
		...
		if (var0 != -1 && GroundItemPile.loadInterface(var0)) {
			...
			for (int var2 = 0; var2 < var1.length; ++var2) {
				...
				if (var3.onLoad != null) {
					...
					GrandExchangeEvent.runScript(var4, 5000000);
				}
			}
		}
	...
	static void alignWidgetSize(Widget component, int parentWidth, int parentHeight, boolean runScripts) {
		...
		if (runScripts && component.onResize != null && (var4 != component.width || var5 != component.height)) {
