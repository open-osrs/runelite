   ...
   public static int compareStrings(CharSequence var0, CharSequence var1, Language var2) {
      ...
      while(var5 - var7 < var3 || var6 - var8 < var4) {
         ...
         if (var9 != var10 && Character.toUpperCase(var9) != Character.toUpperCase(var10)) {
            ...
            if (var9 != var10) {
               return EnumDefinition.lowercaseChar(var9, var2) - EnumDefinition.lowercaseChar(var10, var2);
            }
         }
      }
      ...
      for(var17 = 0; var17 < var16; ++var17) {
         ...
         if (var20 != var18 && Character.toUpperCase(var18) != Character.toUpperCase(var20)) {
            ...
            if (var18 != var20) {
               return EnumDefinition.lowercaseChar(var18, var2) - EnumDefinition.lowercaseChar(var20, var2);
            }
         }
      }
      ...
      if (var17 != 0) {
         ...
         for(int var19 = 0; var19 < var16; ++var19) {
            ...
            if (var20 != var13) {
               return EnumDefinition.lowercaseChar(var20, var2) - EnumDefinition.lowercaseChar(var13, var2);
            }
         }
