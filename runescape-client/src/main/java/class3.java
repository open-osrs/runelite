...
public class class3 implements Enumerated {
      ...
      static final class3 field7 = new class3(1, 0, Integer.class, new class1());
      @ObfuscatedName("n")
      @ObfuscatedSignature(
            signature = "Lu;"
      )
      static final class3 field15 = new class3(0, 1, Long.class, new class2());
      @ObfuscatedName("v")
      @ObfuscatedSignature(
            signature = "Lu;"
      )
      static final class3 field8 = new class3(2, 2, String.class, new class4());
      @ObfuscatedName("ax")
      ...
      static void method51(int var0, int var1, int var2, int var3) {
            for(ObjectSound var4 = (ObjectSound)ObjectSound.objectSounds.last(); var4 != null; var4 = (ObjectSound)ObjectSound.objectSounds.previous()) {
                  if (var4.soundEffectId != -1 || var4.soundEffectIds != null) {
                        ...
                        } else if (var1 < var4.field_7 * 16384) {
                              var5 += var4.field_7 * 16384 - var1;
                        }
