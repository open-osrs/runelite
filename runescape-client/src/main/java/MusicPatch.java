...
public class MusicPatch extends Node {
      ...
      @ObfuscatedName("u")
      byte[] field2459 = new byte[128];
      @ObfuscatedName("r")
      byte[] field2456 = new byte[128];
      @ObfuscatedName("p")
      @ObfuscatedSignature(
            signature = "[Lgf;"
      )
      MusicPatchNode2[] field2462 = new MusicPatchNode2[128];
      @ObfuscatedName("q")
      byte[] field2460 = new byte[128];
      @ObfuscatedName("m")
      int[] field2463 = new int[128];
      ...
      MusicPatch(byte[] var1) {
            ...
            for(var20 = 0; var20 < 128; ++var20) {
                  var19 += var2.readUnsignedByte();
                  this.field2457[var20] = (short)(this.field2457[var20] + (var19 << 8));
            }
            ...
            for(var23 = 0; var23 < 128; ++var23) {
                  ...
                  this.field2457[var23] = (short)(this.field2457[var23] + ((var22 - 1 & 2) << 14));
