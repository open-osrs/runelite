...
public class MusicPatch extends Node {
	...
	MusicPatch(byte[] var1) {
		...
		this.field2494 = new short[128]; // L: 22
		this.field2495 = new byte[128]; // L: 23
		this.field2496 = new byte[128]; // L: 24
		this.field2492 = new MusicPatchNode2[128]; // L: 25
		this.field2498 = new byte[128]; // L: 26
		this.field2500 = new int[128]; // L: 27
		...
		for (var14 = 0; var14 < var39.length; ++var14) { // L: 69
			...
			if (var42 > 0) { // L: 72
				var15.field2411 = new byte[var42 * 2];
			}

			var42 = var2.readUnsignedByte(); // L: 73
			if (var42 > 0) { // L: 74
				var15.field2412 = new byte[var42 * 2 + 2]; // L: 75
				var15.field2412[1] = 64; // L: 76
			}
		}
		...
		for (var20 = 0; var20 < 128; ++var20) { // L: 90
			...
			this.field2494[var20] = (short)var19; // L: 92
		}
		...
		for (var23 = 0; var23 < 128; ++var23) { // L: 102
			...
			var50 = this.field2494; // L: 108
			var50[var23] = (short)(var50[var23] + ((var22 - 1 & 2) << 14));
			this.field2500[var23] = var22; // L: 109
			--var20; // L: 110
		}
		...
		for (var24 = 0; var24 < 128; ++var24) { // L: 115
			if (this.field2500[var24] != 0) { // L: 116
				if (var20 == 0) { // L: 117
				...
				this.field2498[var24] = (byte)var23; // L: 122
				--var20; // L: 123
			}
		}
		...
		for (int var25 = 0; var25 < 128; ++var25) { // L: 128
			if (this.field2500[var25] != 0) { // L: 129
				if (var20 == 0) { // L: 130
				...
				this.field2496[var25] = (byte)var24; // L: 135
				--var20; // L: 136
			}
		}
		...
		for (var26 = 0; var26 < 128; ++var26) { // L: 141
			if (this.field2500[var26] != 0) { // L: 142
				if (var20 == 0) { // L: 143
				...
				this.field2492[var26] = var40; // L: 148
				--var20; // L: 149
			}
		}
		...
		for (var27 = 0; var27 < 128; ++var27) { // L: 154
			if (var20 == 0) { // L: 155
				...
				if (this.field2500[var27] > 0) { // L: 158
					var26 = var2.readUnsignedByte() + 1;
				}
			}

			this.field2495[var27] = (byte)var26; // L: 160
			--var20; // L: 161
		}

		this.field2499 = var2.readUnsignedByte() + 1; // L: 163

		int var29;
		MusicPatchNode2 var41;
		for (var27 = 0; var27 < var12; ++var27) { // L: 164
			var41 = var39[var27]; // L: 165
			if (var41.field2411 != null) { // L: 166
				for (var29 = 1; var29 < var41.field2411.length; var29 += 2) { // L: 167
					var41.field2411[var29] = var2.readByte();
				}
			}

			if (var41.field2412 != null) { // L: 169
				for (var29 = 3; var29 < var41.field2412.length - 2; var29 += 2) { // L: 170
					var41.field2412[var29] = var2.readByte();
				}
			}
		}
		...
		for (var27 = 0; var27 < var12; ++var27) { // L: 179
			...
			if (var41.field2412 != null) { // L: 181
				var19 = 0; // L: 182

				for (var29 = 2; var29 < var41.field2412.length; var29 += 2) { // L: 183
					var19 = 1 + var19 + var2.readUnsignedByte(); // L: 184
					var41.field2412[var29] = (byte)var19; // L: 185
				}
			}
		}
		...
		for (var27 = 0; var27 < var12; ++var27) { // L: 189
			...
			if (var41.field2411 != null) { // L: 191
				var19 = 0; // L: 192

				for (var29 = 2; var29 < var41.field2411.length; var29 += 2) { // L: 193
					var19 = var19 + 1 + var2.readUnsignedByte(); // L: 194
					var41.field2411[var29] = (byte)var19; // L: 195
				}
			}
		}
		...
		if (var44 != null) { // L: 199
			...
			for (var29 = 0; var29 < var49; ++var29) { // L: 208
				this.field2495[var29] = (byte)(var28 * this.field2495[var29] + 32 >> 6);
			}
			...
			for (var29 = 2; var29 < var44.length; var29 += 2) { // L: 209 210 227
				...
				for (var33 = var49; var33 < var30; ++var33) { // L: 214
					...
					this.field2495[var33] = (byte)(var34 * this.field2495[var33] + 32 >> 6); // L: 222
			...
			for (var47 = var49; var47 < 128; ++var47) { // L: 229
				this.field2495[var47] = (byte)(var28 * this.field2495[var47] + 32 >> 6);
			}
		...
		if (var16 != null) { // L: 232
			...
			for (var29 = 0; var29 < var49; ++var29) { // L: 241
				var47 = var46 + (this.field2496[var29] & 255); // L: 242
				if (var47 < 0) { // L: 243
					var47 = 0;
				}
				...
				this.field2496[var29] = (byte)var47; // L: 245
			}
			...
			for (var29 = 2; var29 < var16.length; var29 += 2) { // L: 247 248 268
				...
				for (var33 = var49; var33 < var30; ++var33) { // L: 252
					...
					int var37 = var34 + (this.field2496[var33] & 255); // L: 260
					if (var37 < 0) { // L: 261
						var37 = 0;
					}
					...
					this.field2496[var33] = (byte)var37; // L: 263
			...
			for (var47 = var49; var47 < 128; ++var47) { // L: 270
				var48 = var46 + (this.field2496[var47] & 255); // L: 271
				if (var48 < 0) { // L: 272
					var48 = 0;
				}
				...
				this.field2496[var47] = (byte)var48; // L: 274
			}
		...
		for (var27 = 0; var27 < var12; ++var27) { // L: 279
			...
			if (var41.field2411 != null) { // L: 281
				var41.field2417 = var2.readUnsignedByte();
			}

			if (var41.field2412 != null) { // L: 282
				var41.field2413 = var2.readUnsignedByte();
			}

			if (var41.field2410 > 0) { // L: 283
				var41.field2414 = var2.readUnsignedByte();
			}
		}
		...
		for (var27 = 0; var27 < var12; ++var27) { // L: 286
			...
			if (var41.field2416 > 0) { // L: 288
				var41.field2415 = var2.readUnsignedByte();
			}
		}

		for (var27 = 0; var27 < var12; ++var27) { // L: 290
			var41 = var39[var27]; // L: 291
			if (var41.field2415 > 0) { // L: 292
				var41.field2409 = var2.readUnsignedByte();
			}
		}
	...
	boolean method3920(SoundCache var1, byte[] var2, int[] var3) {
		...
		for (int var7 = 0; var7 < 128; ++var7) { // L: 300
			if (var2 == null || var2[var7] != 0) { // L: 301
				int var8 = this.field2500[var7]; // L: 302
				if (var8 != 0) { // L: 303
					if (var5 != var8) { // L: 304
						var5 = var8--; // L: 305 306
						if ((var8 & 1) == 0) { // L: 307
