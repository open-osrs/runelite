...
public class MusicPatchNode extends Node {
      ...
      static final void method3789(Widget var0, int var1, int var2) {
            if (var0.buttonType == 1) {
                  WorldMapData_1.insertMenuItemNoShift(var0.buttonText, "", 24, 0, 0, var0.field_9);
            }
            ...
            if (var0.buttonType == 2 && !Client.isSpellSelected) {
                  ...
                  if (var3 != null) {
                        WorldMapData_1.insertMenuItemNoShift(var3, World.colorStartTag(65280) + var0.spellName, 25, 0, -1, var0.field_9);
                  }
            }

            if (var0.buttonType == 3) {
                  WorldMapData_1.insertMenuItemNoShift("Close", "", 26, 0, 0, var0.field_9);
            }

            if (var0.buttonType == 4) {
                  WorldMapData_1.insertMenuItemNoShift(var0.buttonText, "", 28, 0, 0, var0.field_9);
            }

            if (var0.buttonType == 5) {
                  WorldMapData_1.insertMenuItemNoShift(var0.buttonText, "", 29, 0, 0, var0.field_9);
            }

            if (var0.buttonType == 6 && Client.meslayerContinueWidget == null) {
                  WorldMapData_1.insertMenuItemNoShift(var0.buttonText, "", 30, 0, -1, var0.field_9);
            }
                              ...
                              if (var1 >= var6 && var2 >= var7 && var1 < var6 + 32 && var2 < var7 + 32) {
                                    ...
                                    if (var0.itemIds[var19] > 0) {
                                          label331: {
                                                ...
                                                if (Client.isSpellSelected) {
                                                      ...
                                                      if (var9) {
                                                            if ((ItemContainer.selectedSpellFlags & 16) == 16) {
                                                                  WorldMapData_1.insertMenuItemNoShift(Client.selectedSpellActionName, Client.selectedSpellName + " " + "->" + " " + World.colorStartTag(16748608) + var8.name, 32, var8.field_15, var19, var0.field_9);
                                                            }
                                                            break label331;
                                                      }
                                                }
                                                ...
                                                if (var24) {
                                                      WorldMapData_1.insertMenuItemNoShift("Use", World.colorStartTag(16748608) + var8.name, 38, var8.field_15, var19, var0.field_9);
                                                }
                                                ...
                                                if (var20 != null) {
                                                      for(var17 = 4; var17 >= 0; --var17) {
                                                            if (var20[var17] != null) {
                                                                  ...
                                                                  WorldMapData_1.insertMenuItemNoShift(var20[var17], World.colorStartTag(16748608) + var8.name, var18, var8.field_15, var19, var0.field_9);
                                                            }
                                                      }
                                                }

                                                WorldMapData_1.insertMenuItemNoShift("Examine", World.colorStartTag(16748608) + var8.name, 1005, var8.field_15, var19, var0.field_9);
                                          }
                                    }
                              }
            ...
            if (var0.isIf3) {
                  if (Client.isSpellSelected) {
                        ...
                        if (var25 && (ItemContainer.selectedSpellFlags & 32) == 32) {
                              WorldMapData_1.insertMenuItemNoShift(Client.selectedSpellActionName, Client.selectedSpellName + " " + "->" + " " + var0.dataText, 58, 0, var0.childIndex, var0.field_9);
                        }
                  } else {
                        for(var19 = 9; var19 >= 5; --var19) {
                              String var21 = FaceNormal.method3224(var0, var19);
                              if (var21 != null) {
                                    WorldMapData_1.insertMenuItemNoShift(var21, var0.dataText, 1007, var19 + 1, var0.childIndex, var0.field_9);
                              }
                        }

                        var3 = VerticalAlignment.method4309(var0);
                        if (var3 != null) {
                              WorldMapData_1.insertMenuItemNoShift(var3, var0.dataText, 25, 0, var0.childIndex, var0.field_9);
                        }

                        for(var4 = 4; var4 >= 0; --var4) {
                              String var22 = FaceNormal.method3224(var0, var4);
                              if (var22 != null) {
                                    AttackOption.insertMenuItem(var22, var0.dataText, 57, var4 + 1, var0.childIndex, var0.field_9, var0.field2687);
                              }
                        }
                        ...
                        if (var23) {
                              WorldMapData_1.insertMenuItemNoShift("Continue", "", 30, 0, var0.childIndex, var0.field_9);
                        }
                  }
            }
                  ...
                  if (var9 != null && var9.parentId == var1 && (!var9.isIf3 || var9.type == 0 || var9.hasListener || class2.getWidgetClickMask(var9) != 0 || var9 == Client.clickedWidgetParent || var9.contentType == 1338)) {
                        ...
                        if (var9.field2619) {
                              ...
                              default:
                                    break;
                              case 2:
                                    if (Client.field824 == var9.field_9 >>> 16) {
                                          var32 = true;
                                    }
                                    break;
                              case 3:
                                    if (var9.field_9 == Client.field824) {
                                          var32 = true;
                                    }
                              }
                        }
                        ...
                        if (var32 || !var9.isIf3 || var12 < var14 && var13 < var15) {
                              ...
                              if (var9.contentType == 1337) {
                                    ...
                                    if (var9.type == 0) {
                                          updateInterface(var0, var9.field_9, var12, var13, var14, var15, var10 - var9.scrollX, var11 - var9.scrollY);
                                          if (var9.children != null) {
                                                updateInterface(var9.children, var9.field_9, var12, var13, var14, var15, var10 - var9.scrollX, var11 - var9.scrollY);
                                          }

                                          InterfaceParent var30 = (InterfaceParent)Client.interfaceParents.get((long)var9.field_9);
                                          if (var30 != null) {
