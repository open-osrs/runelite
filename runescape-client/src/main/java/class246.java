...
public class class246 {
	...
	static final void drawModelComponents(Widget[] var0, int var1) {
		for (int var2 = 0; var2 < var0.length; ++var2) { // L: 11056
			...
			if (var3 != null && var3.parentId == var1 && (!var3.isIf3 || !class35.isComponentHidden(var3))) { // L: 11058 11059 11060
				if (var3.type == 0) { // L: 11061
					if (!var3.isIf3 && class35.isComponentHidden(var3) && var3 != MusicPatchNode.mousedOverWidgetIf1) { // L: 11062
						continue;
					}
					...
					InterfaceParent var4 = (InterfaceParent)Client.interfaceParents.get((long)var3.id); // L: 11065
				...
				if (var3.type == 6) { // L: 11068
					...
					if (var3.sequenceId != -1 || var3.sequenceId2 != -1) { // L: 11069
						...
						if (var5 != -1) { // L: 11074
							SequenceDefinition var6 = WorldMapScaleHandler.SequenceDefinition_get(var5); // L: 11075

							for (var3.modelFrameCycle += Client.field683; var3.modelFrameCycle > var6.frameLengths[var3.modelFrame]; Script.invalidateWidget(var3)) { // L: 11076 11077 11084
