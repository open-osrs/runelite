...
public class LoginScreenAnimation {
      ...
      void initColors() {
            ...
            for(var1 = 0; var1 < 64; ++var1) {
                  this.field1021[var1 + 64] = var1 * 4 + '\uff00';
            }

            for(var1 = 0; var1 < 64; ++var1) {
                  this.field1021[var1 + 128] = var1 * 262144 + '\uffff';
            }
            ...
            this.field1029 = 0;
            this.field1031 = new int['耀'];
            this.field1015 = new int['耀'];
            ...
            for(int var3 = 1; var3 < 255; ++var3) {
                  ...
                  for(int var9 = var6; var9 < var7; ++var9) {
                        ...
                        if (var10 != 0 && var11 >= Rasterizer2D.Rasterizer2D_xClipStart && var11 < Rasterizer2D.Rasterizer2D_xClipEnd) {
                              ...
                              class42.rasterProvider.pixels[var8++] = -16777216 | ((var14 & 16711935) * var13 + (var10 & 16711935) * var12 & -16711936) + (var12 * (var10 & '\uff00') + var13 * (var14 & '\uff00') & 16711680) >> 8;
                        } else {
                              ++var8;
                        }
                  }
