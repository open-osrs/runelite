...
public class TextureProvider implements TextureLoader {
	...
	public int[] load(int var1) {
		...
		if (var2 != null) {
			...
			boolean var3 = var2.method320(this.brightness, this.textureSize, this.archive);
			if (var3) {
				if (this.remaining == 0) {
	...
	public static int method2777(Buffer var0, String var1) {
		...
		var0.offset += class303.huffman.compress(var3, 0, var3.length, var0.array, var0.offset);
	...
	static int method2752(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.INTERPOLATE) {
			...
			var3 = Interpreter.Interpreter_intStack[RouteStrategy.Interpreter_intStackSize]; // 0
			var4 = Interpreter.Interpreter_intStack[RouteStrategy.Interpreter_intStackSize + 1]; // $2
			int var11 = Interpreter.Interpreter_intStack[RouteStrategy.Interpreter_intStackSize + 2]; // 0
			int var6 = Interpreter.Interpreter_intStack[RouteStrategy.Interpreter_intStackSize + 3]; // 16
			int var12 = Interpreter.Interpreter_intStack[RouteStrategy.Interpreter_intStackSize + 4]; // #int10
