...
public class FriendSystem {
	...
	final void method102() {
		for (FriendLoginUpdate var1 = (FriendLoginUpdate)this.friendsList.friendLoginUpdates.last(); var1 != null; var1 = (FriendLoginUpdate)this.friendsList.friendLoginUpdates.previous()) {
			if ((long)var1.time < class203.currentTimeMs() / 1000L - 5L) {
				if (var1.world > 0) {
					WorldMapIcon_0.addGameMessage(5, "", var1.username + " has logged in.");
				}

				if (var1.world == 0) {
					WorldMapIcon_0.addGameMessage(5, "", var1.username + " has logged out.");
				}
		...
		if (var1 != null) {
			...
			if (var2.hasCleanName()) {
				...
				if (this.canAddFriend()) {
					...
					WorldMapIcon_0.addGameMessage(30, "", var4);
	...
	final boolean canAddFriend() {
		return this.friendsList.isFull() || this.friendsList.getSize() >= 200 && Client.field209 != 1;
	}
	...
	final boolean canAddIgnore() {
		return this.ignoreList.isFull() || this.ignoreList.getSize() >= 100 && Client.field209 != 1;
	}
