...
public class MouseRecorder implements Runnable {
      ...
      @ObfuscatedName("u")
      @Export("xs")
      int[] field_31 = new int[500];
      // $FF: renamed from: ys int[]
      @ObfuscatedName("r")
      @Export("ys")
      int[] field_32 = new int[500];
      @ObfuscatedName("p")
      @Export("millis")
      ...
      public void run() {
            while(this.isRunning) {
                  ...
                  synchronized(this.lock) {
                        if (this.index < 500) {
                              this.field_31[this.index] = MouseHandler.MouseHandler_x;
                              this.field_32[this.index] = MouseHandler.MouseHandler_y;
            ...
            for(int var2 = 0; var2 < var0.length; ++var2) {
                  ...
                  if (var3 != null) {
                        if (var3.type == 0) {
                              ...
                              InterfaceParent var4 = (InterfaceParent)Client.interfaceParents.get((long)var3.field_9);
                              if (var4 != null) {
                        ...
                        if (var1 == 1 && var3.onSubChange != null) {
                              if (var3.childIndex >= 0) {
                                    Widget var6 = Canvas.getWidget(var3.field_9);
