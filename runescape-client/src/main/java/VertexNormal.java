   ...
   static synchronized void method2984(byte[] var0) {
      if (var0.length == 100 && ByteArrayPool.ByteArrayPool_smallCount < 1000) {
         ...
         for (int var1 = 0; var1 < ByteArrayPool.field55.length; ++var1) {
            if (var0.length == ByteArrayPool.field55[var1] && WorldMapSection1.field1082[var1] < RouteStrategy.field760[var1].length) {
               RouteStrategy.field760[var1][WorldMapSection1.field1082[var1]++] = var0;
               return;
            }
         }
      }
