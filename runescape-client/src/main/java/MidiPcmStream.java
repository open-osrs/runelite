...
public class MidiPcmStream extends PcmStream {
      ...
      @ObfuscatedName("c")
      int[] field2402 = new int[16];
      @ObfuscatedName("b")
      int[] field2403 = new int[16];
      @ObfuscatedName("h")
      int[] field2404 = new int[16];
      @ObfuscatedName("s")
      int[] field2392 = new int[16];
      @ObfuscatedName("f")
      ...
      @ObfuscatedName("l")
      int[] field2401 = new int[16];
      @ObfuscatedName("k")
      @ObfuscatedSignature(
            signature = "[[Lgu;"
      )
      MusicPatchNode[][] field2410 = new MusicPatchNode[16][128];
      @ObfuscatedName("ac")
      @ObfuscatedSignature(
            signature = "[[Lgu;"
      )
      MusicPatchNode[][] field2411 = new MusicPatchNode[16][128];
      @ObfuscatedName("az")
      @ObfuscatedSignature(
            signature = "Lgc;"
      )
      ...
      void method3759(int var1) {
            ...
            if (var2 == 128) {
                  ...
                  if (var4 == 64) {
                        if (var5 >= 64) {
                              this.field2404[var3] |= 1;
                        } else {
                              this.field2404[var3] &= -2;
                        }
                  }
                  ...
                  if (var4 == 81) {
                        if (var5 >= 64) {
                              this.field2404[var3] |= 4;
                        } else {
                              this.method3683(var3);
                              this.field2404[var3] &= -5;
                        }
                  }
