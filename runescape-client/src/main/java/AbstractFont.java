      ...
      void decodeTag(String var1) {
            try {
                  if (var1.startsWith("col=")) {
                        AbstractFont_color = class2.parseIntCustomRadix(var1.substring(4), 16);
                  } else if (var1.equals("/col")) {
                        AbstractFont_color = AbstractFont_previousColor;
                  } else if (var1.startsWith("str=")) {
                        AbstractFont_strike = class2.parseIntCustomRadix(var1.substring(4), 16);
                  } else if (var1.equals("str")) {
                        AbstractFont_strike = 8388608;
                  } else if (var1.equals("/str")) {
                        AbstractFont_strike = -1;
                  } else if (var1.startsWith("u=")) {
                        AbstractFont_underline = class2.parseIntCustomRadix(var1.substring(2), 16);
                  } else if (var1.equals("u")) {
                        AbstractFont_underline = 0;
                  } else if (var1.equals("/u")) {
                        AbstractFont_underline = -1;
                  } else if (var1.startsWith("shad=")) {
                        AbstractFont_shadow = class2.parseIntCustomRadix(var1.substring(5), 16);
                        ...
                        if (var7 == '<') {
                              ...
                              if (var4 == -1) {
                                    ...
                                    if (AbstractFont_strike != -1) {
                                          Rasterizer2D.method5935(var2, var3 + (int)((double)this.ascent * 0.7D), var13, AbstractFont_strike);
                                    }

                                    if (AbstractFont_underline != -1) {
                                          Rasterizer2D.method5935(var2, var3 + this.ascent + 1, var13, AbstractFont_underline);
                                    }
                  ...
                  if (var1.charAt(var9) != 0) {
                        ...
                        if (var10 == '<') {
                              ...
                              if (var6 == -1) {
                                    ...
                                    if (AbstractFont_strike != -1) {
                                          Rasterizer2D.method5935(var2, var3 + (int)((double)this.ascent * 0.7D), var18, AbstractFont_strike);
                                    }

                                    if (AbstractFont_underline != -1) {
                                          Rasterizer2D.method5935(var2, var3 + this.ascent, var18, AbstractFont_underline);
                                    }
