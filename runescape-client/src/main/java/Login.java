...
public class Login {
	...
	public static void method2076(AbstractArchive var0, int var1, int var2, int var3, boolean var4) {
		...
		FillMode.musicTrackBoolean = var4;
	...
	static final int method2061() {
		...
		int var0 = class32.getTileHeight(WorldMapSection3.cameraX, GrandExchangeOfferNameComparator.cameraZ, SoundSystem.plane);
		return var0 - GrandExchangeEvents.cameraY < 800 && (Tiles.Tiles_renderFlags[SoundSystem.plane][WorldMapSection3.cameraX >> 7][GrandExchangeOfferNameComparator.cameraZ >> 7] & 4) != 0 ? SoundSystem.plane : 3;
	}
