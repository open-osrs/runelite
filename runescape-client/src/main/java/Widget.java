...
public class Widget extends Node {
	...
	public Sprite getSprite(boolean var1) {
		...
		var5 = class322.SpriteBuffer_tryCreateSprite(Widget_spritesArchive, var2, 0);
		if (var5 == null) {
			field957 = true;
			return null;
		}
	...
	public Font getFont() {
		...
		var1 = GraphicsDefaults.loadFont(Widget_spritesArchive, WorldMapSprite.Widget_fontsArchive, this.fontId, 0);
		if (var1 != null) {
	...
	public Sprite getInventorySprite(int var1) {
		...
		if (var1 >= 0 && var1 < this.inventorySprites.length) {
			...
			var3 = class322.SpriteBuffer_tryCreateSprite(Widget_spritesArchive, var2, 0);
			if (var3 != null) {
