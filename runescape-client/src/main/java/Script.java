...
public class Script extends DualNode {
	...
	static void addSequenceSoundEffect(SequenceDefinition sequence, int frame, int x, int y) {
		if (Client.soundEffectCount < 50 && Client.field115 != 0 && sequence.soundEffects != null && frame < sequence.soundEffects.length) {
			int var4 = sequence.soundEffects[frame];
			if (var4 != 0) {
				int var5 = var4 >> 8;
				int var6 = var4 >> 4 & 7;
				int var7 = var4 & 15;
