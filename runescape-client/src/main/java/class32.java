                        ...
                        label336: {
                              ...
                              if (var18 == 2 && PacketWriter.scene.getObjectFlags(WorldMapRectangle.plane, var15, var17, var11) >= 0) {
                                    ...
                                    if (Client.isItemSelected == 1) {
                                          ...
                                          WorldMapData_1.insertMenuItemNoShift("Examine", World.colorStartTag(65535) + var21.name, 1002, var21.field_14, var16, var17);
                                    }
                              }
                              ...
                              if (var18 == 3) {
                                    ...
                                    if (var34 != null) {
                                          for(TileItem var38 = (TileItem)var34.first(); var38 != null; var38 = (TileItem)var34.next()) {
                                                ItemDefinition var36 = Occluder.ItemDefinition_get(var38.field_23);
                                                if (Client.isItemSelected == 1) {
                                                      WorldMapData_1.insertMenuItemNoShift("Use", Client.selectedItemName + " " + "->" + " " + World.colorStartTag(16748608) + var36.name, 16, var38.field_23, var16, var17);
                                                } else if (Client.isSpellSelected) {
                                                      if ((ItemContainer.selectedSpellFlags & 1) == 1) {
                                                            WorldMapData_1.insertMenuItemNoShift(Client.selectedSpellActionName, Client.selectedSpellName + " " + "->" + " " + World.colorStartTag(16748608) + var36.name, 17, var38.field_23, var16, var17);
                                                      }
                                                } else {
                                                      ...
                                                      for(int var31 = 4; var31 >= 0; --var31) {
                                                            if (var30 != null && var30[var31] != null) {
                                                                  ...
                                                                  WorldMapData_1.insertMenuItemNoShift(var30[var31], World.colorStartTag(16748608) + var36.name, var26, var38.field_23, var16, var17);
                                                            } else if (var31 == 2) {
                                                                  WorldMapData_1.insertMenuItemNoShift("Take", World.colorStartTag(16748608) + var36.name, 20, var38.field_23, var16, var17);
                                                            }
                                                      }

                                                      WorldMapData_1.insertMenuItemNoShift("Examine", World.colorStartTag(16748608) + var36.name, 1004, var38.field_23, var16, var17);
                                                }
                                          }
                                    }
                              }
