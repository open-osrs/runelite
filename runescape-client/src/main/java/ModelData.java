		...
		for (var9 = 0; var9 < var2; ++var9) { // L: 522
			...
			if (var10 != null) { // L: 524
				...
				for (var11 = 0; var11 < var10.textureTriangleCount; ++var11) { // L: 553
					...
					if (var12 == 0) { // L: 555
						this.texTriangleX[this.textureTriangleCount] = (short)this.method3868(var10, var10.texTriangleX[var11]); // L: 556
						this.texTriangleY[this.textureTriangleCount] = (short)this.method3868(var10, var10.texTriangleY[var11]); // L: 557
						this.texTriangleZ[this.textureTriangleCount] = (short)this.method3868(var10, var10.texTriangleZ[var11]); // L: 558
					}
			...
			if (var12 == -1) { // L: 1075
				if (var17 != 0) { // L: 1076
					if (var17 == 1) { // L: 1093
						...
						var8.faceColors1[var16] = method3887(this.faceColors[var16] & '\uffff', var14); // L: 1096
	...
	static void method3885(ModelData var0, ModelData var1, int var2, int var3, int var4, boolean var5) {
		...
		if (var6 >= 3 && var5) { // L: 1012
			for (var9 = 0; var9 < var0.faceCount; ++var9) { // L: 1013
				if (field2197[var0.indices1[var9]] == field2199 && field2197[var0.indices2[var9]] == field2199 && field2197[var0.indices3[var9]] == field2199) { // L: 1014
			...
			for (var9 = 0; var9 < var1.faceCount; ++var9) { // L: 1019
				if (field2199 == field2179[var1.indices1[var9]] && field2199 == field2179[var1.indices2[var9]] && field2199 == field2179[var1.indices3[var9]]) { // L: 1020
