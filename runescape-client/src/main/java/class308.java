...
public class class308 {
	...
	public static void readReflectionCheck(Buffer var0, int var1) {
			...
			try {
				...
				if (var4 != 0 && var4 != 1 && var4 != 2) { // L: 145
					if (var4 == 3 || var4 == 4) { // L: 155
						...
						Class var22 = class23.loadClassFromDescriptor(var20); // L: 173
						if (class23.loadClassFromDescriptor(var5).getClassLoader() == null) { // L: 174
							throw new SecurityException();
						}

						Method[] var13 = class23.loadClassFromDescriptor(var5).getDeclaredMethods(); // L: 175
					...
					if (class23.loadClassFromDescriptor(var5).getClassLoader() == null) { // L: 152
						throw new SecurityException();
					}

					var2.fields[var3] = Reflection.findField(class23.loadClassFromDescriptor(var5), var6); // L: 153
				}
		...
		class105.reflectionChecks.addFirst(var2); // L: 218
	} // L: 219
}
