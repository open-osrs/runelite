...
public class GrandExchangeEvent {
      ...
      GrandExchangeEvent(Buffer var1, byte var2, int var3) {
            ...
            this.grandExchangeOffer.field_29 = var3;
      }
      ...
      static final void method88(PendingSpawn var0) {
            ...
            int var5 = 0;
            if (var0.type == 0) {
                  var1 = PacketWriter.scene.getBoundaryObjectTag(var0.plane, var0.field_4, var0.field_5);
            }

            if (var0.type == 1) {
                  var1 = PacketWriter.scene.getWallDecorationTag(var0.plane, var0.field_4, var0.field_5);
            }

            if (var0.type == 2) {
                  var1 = PacketWriter.scene.getGameObjectTag(var0.plane, var0.field_4, var0.field_5);
            }

            if (var0.type == 3) {
                  var1 = PacketWriter.scene.getFloorDecorationTag(var0.plane, var0.field_4, var0.field_5);
            }

            if (0L != var1) {
                  int var6 = PacketWriter.scene.getObjectFlags(var0.plane, var0.field_4, var0.field_5, var1);
