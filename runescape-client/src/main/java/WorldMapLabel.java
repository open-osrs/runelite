...
public class WorldMapLabel {
	...
	@Export("SpriteBuffer_createIndexedSpriteArray")
	public static IndexedSprite[] SpriteBuffer_createIndexedSpriteArray() {
		IndexedSprite[] var0 = new IndexedSprite[SpriteBuffer.SpriteBuffer_spriteCount];
		...
		for (int var1 = 0; var1 < SpriteBuffer.SpriteBuffer_spriteCount; ++var1) {
			...
			var2.xOffset = SpriteBuffer.SpriteBuffer_xOffsets[var1];
			var2.yOffset = SpriteBuffer.SpriteBuffer_yOffsets[var1];
			...
			var2.palette = SpriteBuffer.SpriteBuffer_spritePalette;
			var2.pixels = SpriteBuffer.SpriteBuffer_pixels[var1];
		}
