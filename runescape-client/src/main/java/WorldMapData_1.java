...
public class WorldMapData_1 extends AbstractWorldMapData {
		...
		if (actor != null && actor.isVisible()) {
			...
			if (var1 < var77 && actor.playerCycle == Client.cycle) {
				...
				if (var10) {
					...
					if (var1 < var77) {
						DevicePcmPlayerProvider.getActorScreenLocation(actor, actor.defaultHeight + 15);
			...
			if (!actor.healthBars.isEmpty()) {
				...
				for (HealthBar var16 = (HealthBar)actor.healthBars.last(); var16 != null; var16 = (HealthBar)actor.healthBars.previous()) {
					...
					if (var17 == null) {
						...
						Sprite var19 = var18.getBackSprite();
						Sprite var20 = var18.getFrontSprite();
						int var21 = 0;
			...
			if (actor.overheadText != null && (var1 >= var77 || !actor.field11 && (Client.publicChatMode == 4 || !actor.isAutoChatting && (Client.publicChatMode == 0 || Client.publicChatMode == 3 || Client.publicChatMode == 1 && ((Player)actor).isFriend())))) {
				DevicePcmPlayerProvider.getActorScreenLocation(actor, actor.defaultHeight);
			...
			for (int var88 = 0; var88 < 4; ++var88) {
				...
				if (var87 - var91 <= Client.cycle) {
					if (var90 == null) {
						...
						DevicePcmPlayerProvider.getActorScreenLocation(actor, actor.defaultHeight / 2);
						if (Client.viewportTempX > -1) {
							if (var88 == 1) {
	...
	static void revalidateWidgetScroll(Widget[] var0, Widget var1, boolean runScripts) {
		int var3 = var1.scrollWidth != 0 ? var1.scrollWidth : var1.width;
		int var4 = var1.scrollHeight != 0 ? var1.scrollHeight : var1.height;
		WorldMapRegion.resizeWidget(var0, var1.id, var3, var4, runScripts);
		if (var1.children != null) {
			WorldMapRegion.resizeWidget(var1.children, var1.id, var3, var4, runScripts);
		}
		...
		if (var5 != null) {
			...
			if (GroundItemPile.loadInterface(var6)) {
				WorldMapRegion.resizeWidget(Widget.Widget_interfaceComponents[var6], -1, var3, var4, runScripts);
			}
		}
