...
public class ObjectDefinition extends DualNode {
      ...
      static ModelData[] field3342 = new ModelData[4];
      ...
      public final Entity getEntity(int var1, int var2, int[][] var3, int var4, int var5, int var6) {
            long var7;
            if (this.models == null) {
                  var7 = (long)(var2 + (this.field_14 << 10));
            } else {
                  var7 = (long)(var2 + (var1 << 3) + (this.field_14 << 10));
            }
      ...
      public final Model getModelDynamic(int var1, int var2, int[][] var3, int var4, int var5, int var6, SequenceDefinition var7, int var8) {
            long var9;
            if (this.models == null) {
                  var9 = (long)(var2 + (this.field_14 << 10));
            } else {
                  var9 = (long)(var2 + (var1 << 3) + (this.field_14 << 10));
            }
