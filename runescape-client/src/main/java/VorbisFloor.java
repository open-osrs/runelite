...
public class VorbisFloor {
	...
	boolean readSubmapFloor() {
		...
		if (!var1) { // L: 154
			...
			int var4 = class111.iLog(var3 - 1); // L: 158
			field285[0] = VorbisSample.readBits(var4); // L: 159
			field285[1] = VorbisSample.readBits(var4); // L: 160
			int var5 = 2; // L: 161
			...
			for (int var6 = 0; var6 < this.partitionClassList.length; ++var6) { // L: 162
				...
				for (int var12 = 0; var12 < var8; ++var12) { // L: 169
					...
					var11 >>>= var9; // L: 171
					field285[var5++] = var13 >= 0 ? VorbisSample.VorbisSample_codebooks[var13].method988() : 0; // L: 172
				}
			}
	...
	void method706(float[] var1, int var2) {
		...
		for (var6 = 2; var6 < var3; ++var6) { // L: 184
			var7 = method699(field284, var6); // L: 185
			var8 = method684(field284, var6); // L: 186
			var9 = this.method685(field284[var7], field285[var7], field284[var8], field285[var8], field284[var6]); // L: 187
			var10 = field285[var6]; // L: 188
			...
			if (var10 != 0) { // L: 192
				...
				if (var10 >= var13) { // L: 198
					field285[var6] = var11 > var9 ? var9 + (var10 - var9) : var11 + (var9 - var10) - 1; // L: 199
				} else {
					field285[var6] = (var10 & 1) != 0 ? var9 - (var10 + 1) / 2 : var10 / 2 + var9; // L: 202
				}
			} else {
				field276[var6] = false; // L: 206
				field285[var6] = var9; // L: 207
			}
		}

		this.VarbisFloor_sort(0, var3 - 1); // L: 210
		var6 = 0; // L: 211
		var7 = field285[0] * this.multiplier; // L: 212

		for (var8 = 1; var8 < var3; ++var8) { // L: 213
			if (field276[var8]) { // L: 214
				var9 = field284[var8]; // L: 215
				var10 = field285[var8] * this.multiplier; // L: 216
				this.method686(var6, var7, var9, var10, var1, var2); // L: 217
				if (var9 >= var2) { // L: 218
					return;
				}
