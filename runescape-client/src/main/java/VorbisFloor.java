...
public class VorbisFloor {
	...
	static {
		field1433 = new int[]{256, 128, 86, 64};
		...
		if (var1 != 1) {
			...
			for (var9 = 0; var9 < var2; ++var9) {
				...
				for (int var8 = 0; var8 < this.classDimensions[var7]; ++var8) {
					this.field1426[var5++] = VorbisSample.readBits(var4);
				}
			}

			if (field1424 == null || field1424.length < var5) {
				field1424 = new int[var5];
				field1434 = new int[var5];
				field1435 = new boolean[var5];
			}
	...
	@ObfuscatedName("j")
	void method2533(int var1, int var2, int var3, int var4, float[] var5, int var6) {
		int var7 = var4 - var2;
		int var8 = var3 - var1;
	...
	void VarbisFloor_sort(int var1, int var2) {
		if (var1 < var2) {
			int var3 = var1;
			int var4 = field1424[var1];
			int var5 = field1434[var1];
			boolean var6 = field1435[var1];
			...
			for (int var7 = var1 + 1; var7 <= var2; ++var7) {
				...
				if (var8 < var4) {
					...
					field1435[var3] = field1435[var7];
					++var3;
					field1424[var7] = field1424[var3];
					field1434[var7] = field1434[var3];
					field1435[var7] = field1435[var3];
				}
			}
	...
	boolean readSubmapFloor() {
		...
		if (!var1) {
			...
			for (var3 = 0; var3 < var2; ++var3) {
				field1424[var3] = this.field1426[var3];
			}

			var3 = field1433[this.multiplier - 1];
			int var4 = WorldMapSection3.iLog(var3 - 1);
			field1434[0] = VorbisSample.readBits(var4);
			field1434[1] = VorbisSample.readBits(var4);
			int var5 = 2;
			...
			for (int var6 = 0; var6 < this.partitionClassList.length; ++var6) {
				...
				int var11 = 0;
				if (var9 > 0) {
					var11 = VorbisSample.VorbisSample_codebooks[this.classMasterbooks[var7]].method2461();
				}

				for (int var12 = 0; var12 < var8; ++var12) {
					int var13 = this.subclassBooks[var7][var11 & var10];
					var11 >>>= var9;
					field1434[var5++] = var13 >= 0 ? VorbisSample.VorbisSample_codebooks[var13].method2461() : 0;
				}
			}
	...
	@ObfuscatedName("n")
	void method2536(float[] var1, int var2) {
		int var3 = this.field1426.length;
		int var4 = field1433[this.multiplier - 1];
		boolean[] var5 = field1435;
		field1435[1] = true;
		var5[0] = true;
		...
		for (var6 = 2; var6 < var3; ++var6) {
			var7 = method2554(field1424, var6);
			var8 = method2544(field1424, var6);
			var9 = this.method2532(field1424[var7], field1434[var7], field1424[var8], field1434[var8], field1424[var6]);
			var10 = field1434[var6];
			int var11 = var4 - var9;
			int var13 = (var11 < var9 ? var11 : var9) << 1;
			if (var10 != 0) {
				boolean[] var14 = field1435;
				field1435[var8] = true;
				var14[var7] = true;
				field1435[var6] = true;
				if (var10 >= var13) {
					field1434[var6] = var11 > var9 ? var9 + (var10 - var9) : var11 + (var9 - var10) - 1;
				} else {
					field1434[var6] = (var10 & 1) != 0 ? var9 - (var10 + 1) / 2 : var10 / 2 + var9;
				}
			} else {
				field1435[var6] = false;
				field1434[var6] = var9;
			}
		}
		...
		var6 = 0;
		var7 = field1434[0] * this.multiplier;

		for (var8 = 1; var8 < var3; ++var8) {
			if (field1435[var8]) {
				var9 = field1424[var8];
				var10 = field1434[var8] * this.multiplier;
				this.method2533(var6, var7, var9, var10, var1, var2);
				if (var9 >= var2) {
					return;
				}
	...
	@ObfuscatedName("m")
	static int method2554(int[] var0, int var1) {
		int var2 = var0[var1];
		int var3 = -1;
	...
	@ObfuscatedName("o")
	static int method2544(int[] var0, int var1) {
		int var2 = var0[var1];
		int var3 = -1;
