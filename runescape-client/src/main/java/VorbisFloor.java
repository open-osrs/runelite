...
public class VorbisFloor
{
      ...
      if (var1 != 1) {
         ...
         for (var9 = 0; var9 < var2; ++var9) {
            ...
            for (int var8 = 0; var8 < this.classDimensions[var6]; ++var8) {
               this.field1353[var5++] = VorbisSample.readBits(var4);
            }
         }
   ...
   boolean readSubmapFloor() {
      ...
      if (!var1) {
         ...
         var3 = field1106[this.multiplier - 1];
         int var4 = WorldMapCacheName.iLog(var3 - 1);
         field1109[0] = VorbisSample.readBits(var4);
         field1109[1] = VorbisSample.readBits(var4);
         int var5 = 2;
         ...
         for (int var6 = 0; var6 < this.partitionClassList.length; ++var6) {
            ...
            int var11 = 0;
            if (var9 > 0) {
               var11 = VorbisSample.VorbisSample_codebooks[this.classMasterbooks[var7]].method2306();
            }

            for (int var12 = 0; var12 < var8; ++var12) {
               int var13 = this.subclassBooks[var7][var11 & var10];
               var11 >>>= var9;
               field1109[var5++] = var13 >= 0 ? VorbisSample.VorbisSample_codebooks[var13].method2306() : 0;
            }
         }
   ...
   void method2375(float[] var1, int var2) {
      ...
      int var4 = field1106[this.multiplier - 1];
      ...
      var6 = 0;
      var7 = field1109[0] * this.multiplier;

      for (var8 = 1; var8 < var3; ++var8) {
         if (field1110[var8]) {
            var9 = field1108[var8];
            var10 = field1109[var8] * this.multiplier;
