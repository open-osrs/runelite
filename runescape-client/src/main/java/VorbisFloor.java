...
public class VorbisFloor {
		...
		if (!var1) { // L: 154
			...
			for (int var6 = 0; var6 < this.partitionClassList.length; ++var6) { // L: 162
				...
				for (int var12 = 0; var12 < var8; ++var12) { // L: 169
					...
					var11 >>>= var9; // L: 171
					field394[var5++] = var13 >= 0 ? VorbisSample.VorbisSample_codebooks[var13].method1111() : 0; // L: 172
				}
			}
	...
	void method815(float[] var1, int var2) {
		...
		for (var6 = 2; var6 < var3; ++var6) { // L: 184
			...
			var9 = this.method811(field384[var7], field394[var7], field384[var8], field394[var8], field384[var6]); // L: 187
			...
			if (var10 != 0) { // L: 192
				...
				if (var10 >= var13) { // L: 198
					field394[var6] = var11 > var9 ? var9 + (var10 - var9) : var11 + (var9 - var10) - 1; // L: 199
				} else {
