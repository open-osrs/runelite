...
public class VorbisFloor {
	...
	VorbisFloor() {
		...
		if (var1 != 1) { // L: 109
			...
			this.field269 = new int[var5]; // L: 137
			this.field269[0] = 0; // L: 138
			this.field269[1] = 1 << var4; // L: 139
			var5 = 2; // L: 140
	...
	boolean readSubmapFloor() {
		...
		if (!var1) { // L: 154
			...
			int var2 = this.field269.length; // L: 155
			...
			var3 = field276[this.multiplier - 1]; // L: 157
			int var4 = class326.iLog(var3 - 1); // L: 158
			field268[0] = VorbisSample.readBits(var4); // L: 159
			field268[1] = VorbisSample.readBits(var4); // L: 160
			int var5 = 2; // L: 161
			...
			for (int var6 = 0; var6 < this.partitionClassList.length; ++var6) { // L: 162
				...
				for (int var12 = 0; var12 < var8; ++var12) { // L: 169
					...
					var11 >>>= var9; // L: 171
					field268[var5++] = var13 >= 0 ? VorbisSample.VorbisSample_codebooks[var13].method999() : 0; // L: 172
				}
			}
	...
	void method700(float[] var1, int var2) {
		int var3 = this.field269.length; // L: 179
		int var4 = field276[this.multiplier - 1]; // L: 180
		...
		for (var6 = 2; var6 < var3; ++var6) { // L: 184
			var7 = method709(field274, var6); // L: 185
			var8 = method705(field274, var6); // L: 186
			var9 = this.method696(field274[var7], field268[var7], field274[var8], field268[var8], field274[var6]); // L: 187
			var10 = field268[var6]; // L: 188
			...
			if (var10 != 0) { // L: 192
				...
				if (var10 >= var13) { // L: 198
					field268[var6] = var11 > var9 ? var9 + (var10 - var9) : var11 + (var9 - var10) - 1; // L: 199
				} else {
					field268[var6] = (var10 & 1) != 0 ? var9 - (var10 + 1) / 2 : var10 / 2 + var9; // L: 202
				}
			} else {
				field278[var6] = false; // L: 206
				field268[var6] = var9; // L: 207
			}
		}

		this.VarbisFloor_sort(0, var3 - 1); // L: 210
		var6 = 0; // L: 211
		var7 = field268[0] * this.multiplier; // L: 212

		for (var8 = 1; var8 < var3; ++var8) { // L: 213
			if (field278[var8]) { // L: 214
				var9 = field274[var8]; // L: 215
				var10 = field268[var8] * this.multiplier; // L: 216
				this.method697(var6, var7, var9, var10, var1, var2); // L: 217
				if (var9 >= var2) { // L: 218
					return;
				}
