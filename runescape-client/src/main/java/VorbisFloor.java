...
public class VorbisFloor {
	...
	static {
		field1411 = new int[]{256, 128, 86, 64}; // L: 8
	...
	VorbisFloor() {
		...
		if (var1 != 1) { // L: 109
			...
			this.field1407 = new int[var5]; // L: 137
			this.field1407[0] = 0; // L: 138
			this.field1407[1] = 1 << var4; // L: 139
			var5 = 2; // L: 140
			...
			if (field1415 == null || field1415.length < var5) { // L: 145
				field1415 = new int[var5]; // L: 146
				field1405 = new int[var5]; // L: 147
				field1416 = new boolean[var5]; // L: 148
			}
	...
	void VarbisFloor_sort(int var1, int var2) {
		if (var1 < var2) { // L: 83
			int var3 = var1; // L: 84
			int var4 = field1415[var1]; // L: 85
			int var5 = field1405[var1]; // L: 86
			boolean var6 = field1416[var1]; // L: 87

			for (int var7 = var1 + 1; var7 <= var2; ++var7) { // L: 88
				int var8 = field1415[var7]; // L: 89
				if (var8 < var4) { // L: 90
					field1415[var3] = var8; // L: 91
					field1405[var3] = field1405[var7]; // L: 92
					field1416[var3] = field1416[var7]; // L: 93
					++var3; // L: 94
					field1415[var7] = field1415[var3]; // L: 95
					field1405[var7] = field1405[var3]; // L: 96
					field1416[var7] = field1416[var3]; // L: 97
				}
			}

			field1415[var3] = var4; // L: 100
			field1405[var3] = var5; // L: 101
			field1416[var3] = var6; // L: 102
	...
	boolean readSubmapFloor() {
		...
		if (!var1) { // L: 154
			...
			int var2 = this.field1407.length; // L: 155
			...
			var3 = field1411[this.multiplier - 1]; // L: 157
			int var4 = Coord.iLog(var3 - 1); // L: 158
			field1405[0] = VorbisSample.readBits(var4); // L: 159
			field1405[1] = VorbisSample.readBits(var4); // L: 160
			int var5 = 2; // L: 161
			...
			for (int var6 = 0; var6 < this.partitionClassList.length; ++var6) { // L: 162
				...
				for (int var12 = 0; var12 < var8; ++var12) { // L: 169
					...
					var11 >>>= var9; // L: 171
					field1405[var5++] = var13 >= 0 ? VorbisSample.VorbisSample_codebooks[var13].method2510() : 0; // L: 172
				}
			}
	...
	void method2590(float[] var1, int var2) {
		int var3 = this.field1407.length; // L: 179
		int var4 = field1411[this.multiplier - 1]; // L: 180
		boolean[] var5 = field1416; // L: 181
		field1416[1] = true; // L: 182
		var5[0] = true; // L: 183
		...
		for (var6 = 2; var6 < var3; ++var6) { // L: 184
			var7 = method2602(field1415, var6); // L: 185
			var8 = method2600(field1415, var6); // L: 186
			var9 = this.method2586(field1415[var7], field1405[var7], field1415[var8], field1405[var8], field1415[var6]); // L: 187
			var10 = field1405[var6]; // L: 188
			int var11 = var4 - var9; // L: 189
			int var13 = (var11 < var9 ? var11 : var9) << 1; // L: 191
			if (var10 != 0) { // L: 192
				boolean[] var14 = field1416; // L: 193
				field1416[var8] = true; // L: 195
				var14[var7] = true; // L: 196
				field1416[var6] = true; // L: 197
				if (var10 >= var13) { // L: 198
					field1405[var6] = var11 > var9 ? var9 + (var10 - var9) : var11 + (var9 - var10) - 1; // L: 199
				} else {
					field1405[var6] = (var10 & 1) != 0 ? var9 - (var10 + 1) / 2 : var10 / 2 + var9; // L: 202
				}
			} else {
				field1416[var6] = false; // L: 206
				field1405[var6] = var9; // L: 207
			}
		}

		this.VarbisFloor_sort(0, var3 - 1); // L: 210
		var6 = 0; // L: 211
		var7 = field1405[0] * this.multiplier; // L: 212

		for (var8 = 1; var8 < var3; ++var8) { // L: 213
			if (field1416[var8]) { // L: 214
				var9 = field1415[var8]; // L: 215
				var10 = field1405[var8] * this.multiplier; // L: 216
				this.method2606(var6, var7, var9, var10, var1, var2); // L: 217
				if (var9 >= var2) { // L: 218
					return;
				}
