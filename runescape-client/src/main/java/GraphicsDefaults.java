...
public class GraphicsDefaults {
	...
	public static Font loadFont(AbstractArchive var0, AbstractArchive var1, int var2, int var3) {
		if (!SpriteMask.SpriteBuffer_loadSprite(var0, var2, var3)) {
			return null;
		}
		...
		if (var4 == null) {
			...
			Font var6 = new Font(var4, SpriteBuffer.SpriteBuffer_xOffsets, SpriteBuffer.SpriteBuffer_yOffsets, VarbitDefinition.SpriteBuffer_spriteWidths, SecureRandomCallable.SpriteBuffer_spriteHeights, SpriteBuffer.SpriteBuffer_spritePalette, SpriteBuffer.SpriteBuffer_pixels);
