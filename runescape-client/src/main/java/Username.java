...
public class Username implements Comparable {
   ...
   static final void drawObject(int var0, int var1, int var2, int var3, int var4) {
      ...
      if (var5 != 0L) {
         ...
         ObjectDefinition var14 = WorldMapAreaData.getObjectDefinition(var13);
      ...
      if (var5 != 0L) {
         ...
         ObjectDefinition var24 = WorldMapAreaData.getObjectDefinition(var10);
         int var19;
      ...
      if (0L != var5) {
         ...
         ObjectDefinition var21 = WorldMapAreaData.getObjectDefinition(var7);
