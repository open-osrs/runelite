...
public class HitSplatDefinition extends DualNode {
   ...
   public Sprite method4769() {
      if (this.field3367 < 0) {
         return null;
      } else {
         Sprite var1 = (Sprite)HitSplatDefinition_cachedSprites.get((long)this.field3367);
         if (var1 != null) {
            return var1;
         } else {
   ...
   public Sprite method4766() {
      if (this.field3372 < 0) {
         return null;
      } else {
         Sprite var1 = (Sprite)HitSplatDefinition_cachedSprites.get((long)this.field3372);
         if (var1 != null) {
            return var1;
         } else {
   ...
   static final void updateItemPile(int var0, int var1) {
      ...
      if (var2 == null) {
         ...
         for(var6 = (TileItem)var2.last(); var6 != null; var6 = (TileItem)var2.previous()) {
            ItemDefinition var7 = class281.ItemDefinition_get(var6.id);
