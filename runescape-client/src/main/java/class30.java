...
public class class30 {
      ...
      static final class30 field253 = new class30(0);
      @ObfuscatedName("n")
      @ObfuscatedSignature(
            signature = "Lap;"
      )
      ...
      static void alignWidgetPosition(Widget var0, int var1, int var2) {
            if (var0.xAlignment == 0) {
                  ...
                  var0.field_10 = var0.rawX + (var1 - var0.width) / 2;
            } else if (var0.xAlignment == 2) {
                  var0.field_10 = var1 - var0.width - var0.rawX;
            } else if (var0.xAlignment == 3) {
                  var0.field_10 = var0.rawX * var1 >> 14;
            } else if (var0.xAlignment == 4) {
                  var0.field_10 = (var1 - var0.width) / 2 + (var0.rawX * var1 >> 14);
            } else {
                  var0.field_10 = var1 - var0.width - (var0.rawX * var1 >> 14);
            }

            if (var0.yAlignment == 0) {
                  var0.field_11 = var0.rawY;
            } else if (var0.yAlignment == 1) {
                  var0.field_11 = (var2 - var0.height) / 2 + var0.rawY;
            } else if (var0.yAlignment == 2) {
                  var0.field_11 = var2 - var0.height - var0.rawY;
            } else if (var0.yAlignment == 3) {
                  var0.field_11 = var2 * var0.rawY >> 14;
            } else if (var0.yAlignment == 4) {
                  var0.field_11 = (var2 * var0.rawY >> 14) + (var2 - var0.height) / 2;
            } else {
                  var0.field_11 = var2 - var0.height - (var2 * var0.rawY >> 14);
            }
