...
public final class Player extends Actor {
	...
	final void method254(int tileX, int tileY, byte var3) {
		...
		if (tileX >= 0 && tileX < 104 && tileY >= 0 && tileY < 104) {
			if (super.pathX[0] >= 0 && super.pathX[0] < 104 && super.pathY[0] >= 0 && super.pathY[0] < 104) {
				if (var3 == 2) {
					WorldMapIcon_1.method316(this, tileX, tileY, (byte)2);
				}

				this.method255(tileX, tileY, var3);
			} else {
	...
	static void method1281() {
		if (Client.isSpellSelected) {
			...
			if (var0 != null && var0.onTargetLeave != null) {
				...
				AbstractArchive.runScriptEvent(var1);
			}
