               ...
               if (class194.field2352 == var0) {
                  ...
                  if (var8 >= 0 && var9 >= 0 && var8 < 103 && var9 < 103) {
                     ...
                     if (var5 == 3) {
                        ...
                        if (var43 != null) {
                           var43.entity = new DynamicObject(class25.Entity_unpackID(var43.tag), 22, var4, class90.Client_plane, var8, var9, var6, false, var43.entity);
                        }
                     }
                  }
                  ...
                  if (class194.field2350 == var0) {
                     ...
                     if (var17 != null) {
                        ObjectDefinition var18 = WorldMapAreaData.getObjectDefinition(var12);
                        int var19;
                        int var20;
                        if (var5 != 1 && var5 != 3) {
                           var19 = var18.sizeX;
