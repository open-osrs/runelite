            ...
            for(int var2 = 0; var2 < var0.length; ++var2) {
                  ...
                  if (var3 != null && var3.parentId == var1 && (!var3.isIf3 || !WorldMapSectionType.isComponentHidden(var3))) {
                        ...
                        if (var3.type == 0) {
                              ...
                              drawModelComponents(var0, var3.field_9);
                              if (var3.children != null) {
                                    drawModelComponents(var3.children, var3.field_9);
                              }

                              InterfaceParent var7 = (InterfaceParent)Client.interfaceParents.get((long)var3.field_9);
                              if (var7 != null) {
                                    var5 = var7.group;
