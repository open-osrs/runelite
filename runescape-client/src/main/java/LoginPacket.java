...
public class LoginPacket implements class181 {
      ...
      public static final LoginPacket field2289 = new LoginPacket(14, 0);
      @ObfuscatedName("n")
      @ObfuscatedSignature(
            signature = "Lge;"
      )
      static final LoginPacket field2288 = new LoginPacket(15, 4);
      @ObfuscatedName("v")
      @ObfuscatedSignature(
            signature = "Lge;"
      )
      public static final LoginPacket field2287 = new LoginPacket(16, -2);
      @ObfuscatedName("u")
      @ObfuscatedSignature(
            signature = "Lge;"
      )
      public static final LoginPacket field2290 = new LoginPacket(18, -2);
      @ObfuscatedName("r")
      @ObfuscatedSignature(
            signature = "Lge;"
      )
      static final LoginPacket field2291 = new LoginPacket(27, 0);
      @ObfuscatedName("q")
      @ObfuscatedSignature(
            signature = "[Lge;"
      )
