...
public class AudioFilter {
      @ObfuscatedName("p")
      static float[][] field1454 = new float[2][8];
      @ObfuscatedName("q")
      @Export("coefficients")
      ...
      int[] pairs = new int[2];
      @ObfuscatedName("v")
      int[][][] field1458 = new int[2][2][4];
      @ObfuscatedName("u")
      int[][][] field1452 = new int[2][2][4];
      @ObfuscatedName("r")
            ...
            if (this.pairs[var1] == 0) {
                  ...
                  for(var4 = 1; var4 < this.pairs[var1]; ++var4) {
                        ...
                        for(int var7 = var4 * 2 - 1; var7 >= 2; --var7) {
                              field1454[var1][var7] += field1454[var1][var7 - 1] * var5 + field1454[var1][var7 - 2] * var6;
                        }

                        field1454[var1][1] += field1454[var1][0] * var5 + var6;
                        field1454[var1][0] += var5;
                  }

                  if (var1 == 0) {
                        for(var4 = 0; var4 < this.pairs[0] * 2; ++var4) {
                              field1454[0][var4] *= field1456;
                        }
                  }
