...
public class TaskHandler implements Runnable {
   ...
   public static final Sprite getItemSprite(int var0, int var1, int var2, int var3, int var4, boolean var5) {
      ...
      ItemDefinition var9 = class281.ItemDefinition_get(var0);
      ...
      if (var19 == null) {
         ...
         if (var4 == 1 || var4 == 2 && var9.isStackable == 1) {
            ItemDefinition.ItemDefinition_fontPlain11.draw(SoundCache.inventoryQuantityFormat(var1), 0, 9, 16776960, 1);
         }
   ...
   static final boolean method3673(int var0, int var1) {
      ObjectDefinition var2 = WorldMapAreaData.getObjectDefinition(var0);
      if (var1 == 11) {
         var1 = 10;
      }
