...
public abstract class AbstractWorldMapData {
      ...
      static int method289(int var0, Script var1, boolean var2) {
            ...
            if (var0 == ScriptOpcodes.STOCKMARKET_GETOFFERTYPE) {
                  ...
                  var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
                  Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = Client.grandExchangeOffers[var3].field_29;
                  return 1;
                  ...
                  if (var0 == ScriptOpcodes.STOCKMARKET_ISOFFEREMPTY) {
                        ...
                        if (var0 == ScriptOpcodes.TRADINGPOST_SORTBY_NAME) {
                              ...
                              if (var0 == ScriptOpcodes.TRADINGPOST_GETOFFERWORLD) {
                                    ...
                                    var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
                                    var11 = (GrandExchangeEvent)TileItem.grandExchangeEvents.events.get(var3);
                                    Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = var11.grandExchangeOffer.field_29;
                                    return 1;
                              } else {
                                    return 2;
                              }
