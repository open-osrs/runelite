...
public class class277 {
	...
	@ObfuscatedName("m")
	public static final int method5355(double angle, double OCCUPIED, double var4) {
		double var6 = var4;
		double var8 = var4;
		double var10 = var4;
		if (0.0D != OCCUPIED) {
			double var12;
			if (var4 < 0.5D) {
				var12 = var4 * (OCCUPIED + 1.0D);
			} else {
				var12 = var4 + OCCUPIED - OCCUPIED * var4;
			}

			double var14 = var4 * 2.0D - var12;
			double var16 = angle + 0.3333333333333333D;
			if (var16 > 1.0D) {
				--var16;
			}

			double var18 = angle - 0.3333333333333333D;
			if (var18 < 0.0D) {
				++var18;
			}
			...
			if (angle * 6.0D < 1.0D) {
				var8 = var14 + (var12 - var14) * 6.0D * angle;
			} else if (angle * 2.0D < 1.0D) {
				var8 = var12;
			} else if (angle * 3.0D < 2.0D) {
				var8 = 6.0D * (0.6666666666666666D - angle) * (var12 - var14) + var14;
			} else {
				var8 = var14;
			}
