      ...
      for(ObjectSound var4 = (ObjectSound)ObjectSound.objectSounds.last(); var4 != null; var4 = (ObjectSound)ObjectSound.objectSounds.previous()) {
         if (var4.soundEffectId != -1 || var4.soundEffectIds != null) {
            ...
            if (var5 - 64 <= var4.field1092 && WorldMapSectionType.clientPreferences.areaSoundEffectsVolume != 0 && var0 == var4.plane) {
               ...
               if (var4.stream1 == null) {
                  if (var4.soundEffectId >= 0) {
                     ...
                     if (var7 != null) {
                        ...
                        var9.setNumLoops(-1);
                        VarbitDefinition.pcmStreamMixer.addSubStream(var9);
                        var4.stream1 = var9;
                     }
                  }
               } else {
               ...
               if (var4.stream2 == null) {
                  if (var4.soundEffectIds != null && (var4.field1097 -= var3) <= 0) {
                     ...
                     if (var12 != null) {
                        ...
                        var10.setNumLoops(0);
                        VarbitDefinition.pcmStreamMixer.addSubStream(var10);
                        var4.stream2 = var10;
               ...
               if (var4.stream1 != null) {
                  VarbitDefinition.pcmStreamMixer.removeSubStream(var4.stream1);
                  var4.stream1 = null;
               }

               if (var4.stream2 != null) {
                  VarbitDefinition.pcmStreamMixer.removeSubStream(var4.stream2);
                  var4.stream2 = null;
               }
            }
         }
      ...
      while(true) {
         ...
         while(true) {
            ...
            if (var17 == var4 && var16 >= var5 && var16 < var5 + 8 && var15 >= var6 && var15 < var6 + 8) {
               ObjectDefinition var21 = WorldMapAreaData.getObjectDefinition(var11);
               int var24 = var16 & 7;
               int var25 = var15 & 7;
               ...
               if (var29 > 0 && var30 > 0 && var29 < 103 && var30 < 103) {
                  ...
                  GameShell.method1134(var1, var29, var30, var11, var20 + var7 & 3, var19, var8, var32);
               }
            }
         }
      }
