...
public final class ArchiveDisk {
	...
	public byte[] read(int entry) {
		...
		synchronized(this.datFile) {
			...
			try {
				...
				int var7 = ((ArchiveDisk_buffer[0] & 255) << 16) + (ArchiveDisk_buffer[2] & 255) + ((ArchiveDisk_buffer[1] & 255) << 8);
				int var8 = (ArchiveDisk_buffer[5] & 255) + ((ArchiveDisk_buffer[3] & 255) << 16) + ((ArchiveDisk_buffer[4] & 255) << 8);
				if (var7 < 0 || var7 > this.maxEntrySize) {
					var5 = null;
					var4 = (byte[])var5;
					var10000 = var4;
					return var10000;
				...
				if (var8 > 0 && (long)var8 <= this.datFile.length() / 520L) {
					...
					while (var10 < var7) {
						...
						this.datFile.seek((long)(var8 * 520));
						int var12 = var7 - var10;
						if (var12 > 512) {
							var12 = 512;
						}

						this.datFile.read(ArchiveDisk_buffer, 0, var12 + 8);
						int var13 = (ArchiveDisk_buffer[1] & 255) + ((ArchiveDisk_buffer[0] & 255) << 8);
						int var14 = (ArchiveDisk_buffer[3] & 255) + ((ArchiveDisk_buffer[2] & 255) << 8);
						int var15 = ((ArchiveDisk_buffer[5] & 255) << 8) + ((ArchiveDisk_buffer[4] & 255) << 16) + (ArchiveDisk_buffer[6] & 255);
						int var16 = ArchiveDisk_buffer[7] & 255;
						if (var13 == entry && var11 == var14 && var16 == this.archive) {
							if (var15 >= 0 && (long)var15 <= this.datFile.length() / 520L) {
								for (int var17 = 0; var17 < var12; ++var17) {
									var9[var10++] = ArchiveDisk_buffer[var17 + 8];
								}
	...
	static final boolean method3585(int var0, int var1, int var2, RouteStrategy var3, CollisionMap var4) {
		...
		while (var13 != var12) {
			...
			var12 = var12 + 1 & 4095;
			int var15 = var5 - var9;
			int var16 = var6 - var10;
			int var17 = var5 - var4.xInset;
			int var18 = var6 - var4.yInset;
			...
			if (var15 < 128 - var2 && var16 < 128 - var2 && class178.directions[var15 + 1][var16 + 1] == 0 && (var14[var17 + var2][var18 + var2] & 19136992) == 0) {
