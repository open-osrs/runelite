...
final class GrandExchangeOfferUnitPriceComparator implements Comparator {
	...
	@Export("drawHintArrow")
	static final void drawHintArrow(int x, int y) {
		if (Client.hintArrowType == 2) {
			...
			if (Client.viewportTempX > -1 && Client.cycle % 20 < 10) {
				Player.headIconHintSprites[0].drawAt2(x + Client.viewportTempX - 12, Client.viewportTempY + y - 28);
			}
		}
