...
public class class16 {
	...
	static final void method189(class190 var0) {
		...
		if (class190.field2342 == var0) {
			...
			int var15 = (var11 >> 4 & 7) + WorldMapSection2.field1089;
		...
		if (class190.field2349 == var0) {
			var31 = var1.method58();
			var2 = (var31 >> 4 & 7) + WorldMapSection2.field1089;
			...
			if (class190.field2341 == var0) {
				...
				var4 = (var3 >> 4 & 7) + WorldMapSection2.field1089;
				...
				if (class190.field2344 == var0) {
					...
					var5 = (var4 >> 4 & 7) + WorldMapSection2.field1089;
					...
					if (class190.field2347 == var0) {
						...
						var7 = var1.method65();
						var8 = var1.method58();
						var35 = (var8 >> 4 & 7) + WorldMapSection2.field1089;
						...
						if (class190.field2343 == var0) {
							...
							var2 = var1.method67();
							var32 = var1.method58();
							var3 = (var32 >> 4 & 7) + WorldMapSection2.field1089;
