...
public class class349 {
	...
	static {
		field4077 = new char[]{' ', ' ', '_', '-', 'à', 'á', 'â', 'ä', 'ã', 'À', 'Á', 'Â', 'Ä', 'Ã', 'è', 'é', 'ê', 'ë', 'È', 'É', 'Ê', 'Ë', 'í', 'î', 'ï', 'Í', 'Î', 'Ï', 'ò', 'ó', 'ô', 'ö', 'õ', 'Ò', 'Ó', 'Ô', 'Ö', 'Õ', 'ù', 'ú', 'û', 'ü', 'Ù', 'Ú', 'Û', 'Ü', 'ç', 'Ç', 'ÿ', 'Ÿ', 'ñ', 'Ñ', 'ß'}; // L: 8
		field4079 = new char[]{'[', ']', '#'}; // L: 9
	}
	...
	static void readPlayerUpdate(PacketBuffer var0, int var1) {
		...
		if (var3 == 0) { // L: 203
			if (var2) { // L: 204
				var4.field631 = false; // L: 205
			} else if (Client.localPlayerIndex == var1) { // L: 208
				throw new RuntimeException();
			} else {
				Players.Players_regions[var1] = (var4.plane << 28) + (NetFileRequest.baseX + var4.pathX[0] >> 13 << 14) + (class41.baseY + var4.pathY[0] >> 13); // L: 209
				if (var4.field959 != -1) { // L: 210
			...
			if (var3 == 1) { // L: 217
				...
				if (Client.localPlayerIndex == var1 && (var4.x < 1536 || var4.y < 1536 || var4.x >= 11776 || var4.y >= 11776)) { // L: 241
					...
					var4.field631 = false; // L: 243
				} else if (var2) { // L: 245
					var4.field631 = true; // L: 246
					var4.tileX = var6; // L: 247
					var4.tileY = var7; // L: 248
				} else {
					var4.field631 = false; // L: 251
					var4.method1313(var6, var7, Players.field1253[var1]); // L: 252
				}
				...
				if (Client.localPlayerIndex != var1 || var4.x >= 1536 && var4.y >= 1536 && var4.x < 11776 && var4.y < 11776) { // L: 312
					if (var2) { // L: 316
						var4.field631 = true; // L: 317
						var4.tileX = var6; // L: 318
						var4.tileY = var7; // L: 319
					} else {
						var4.field631 = false; // L: 322
						var4.method1313(var6, var7, Players.field1253[var1]); // L: 323
					}
				} else {
					var4.resetPath(var6, var7); // L: 313
					var4.field631 = false; // L: 314
				}
				...
				if (var5 == 0) { // L: 328
					...
					if (Client.localPlayerIndex != var1 || var4.x >= 1536 && var4.y >= 1536 && var4.x < 11776 && var4.y < 11776) { // L: 337
						if (var2) { // L: 341
							var4.field631 = true; // L: 342
							var4.tileX = var10; // L: 343
							var4.tileY = var11; // L: 344
						} else {
							var4.field631 = false; // L: 347
							var4.method1313(var10, var11, Players.field1253[var1]); // L: 348
						}
					} else {
						var4.resetPath(var10, var11); // L: 338
						var4.field631 = false; // L: 339
					}
					...
					var10 = (var8 + NetFileRequest.baseX + var4.pathX[0] & 16383) - NetFileRequest.baseX; // L: 358
					var11 = (var9 + class41.baseY + var4.pathY[0] & 16383) - class41.baseY; // L: 359
					if (Client.localPlayerIndex == var1 && (var4.x < 1536 || var4.y < 1536 || var4.x >= 11776 || var4.y >= 11776)) { // L: 360
						var4.resetPath(var10, var11); // L: 361
						var4.field631 = false; // L: 362
					} else if (var2) { // L: 364
						var4.field631 = true; // L: 365
						var4.tileX = var10; // L: 366
						var4.tileY = var11; // L: 367
					} else {
						var4.field631 = false; // L: 370
						var4.method1313(var10, var11, Players.field1253[var1]); // L: 371
					}
