   ...
   static final void addPendingSpawnToScene(int var0, int var1, int var2, int var3, int var4, int var5, int var6) {
      if (var2 >= 1 && var3 >= 1 && var2 <= 102 && var3 <= 102) {
         ...
         if (var4 >= 0) {
            ...
            ObjectDefinition var15 = WorldMapAreaData.getObjectDefinition(var4);
            int var16;
            int var17;
            if (var5 != 1 && var5 != 3) {
               var16 = var15.sizeX;
            ...
            if (var6 == 22) {
               if (var15.animationId == -1 && var15.transforms == null) {
                  ...
                  var36 = new DynamicObject(var4, 22, var5, var12, var2, var3, var15.animationId, var15.field3429, (Entity)null);
               }

               var41.newFloorDecoration(var0, var2, var3, var23, (Entity)var36, var26, var28);
               ...
               if (var6 >= 12) {
                  if (var15.animationId == -1 && var15.transforms == null) {
                     ...
                     var36 = new DynamicObject(var4, var6, var5, var12, var2, var3, var15.animationId, var15.field3429, (Entity)null);
                  }

                  var41.method3400(var0, var2, var3, var23, 1, 1, (Entity)var36, 0, var26, var28);
                  ...
                  if (var15.animationId == -1 && var15.transforms == null) {
                     ...
                     var36 = new DynamicObject(var4, 0, var5, var12, var2, var3, var15.animationId, var15.field3429, (Entity)null);
                  }

                  var41.newBoundaryObject(var0, var2, var3, var23, (Entity)var36, (Entity)null, Tiles.field521[var5], 0, var26, var28);
                  if (var15.interactType != 0) {
                  ...
                  if (var15.animationId == -1 && var15.transforms == null) {
                     ...
                     var36 = new DynamicObject(var4, 1, var5, var12, var2, var3, var15.animationId, var15.field3429, (Entity)null);
                  }

                  var41.newBoundaryObject(var0, var2, var3, var23, (Entity)var36, (Entity)null, Tiles.field514[var5], 0, var26, var28);
                  if (var15.interactType != 0) {
                     var14.method3749(var2, var3, var6, var5, var15.boolean1);
                  }
               } else {
                  ...
                  if (var6 == 2) {
                     ...
                     if (var15.animationId == -1 && var15.transforms == null) {
                        ...
                        var37 = new DynamicObject(var4, 2, var5 + 4, var12, var2, var3, var15.animationId, var15.field3429, (Entity)null);
                        var31 = new DynamicObject(var4, 2, var29, var12, var2, var3, var15.animationId, var15.field3429, (Entity)null);
                     }

                     var41.newBoundaryObject(var0, var2, var3, var23, (Entity)var37, (Entity)var31, Tiles.field521[var5], Tiles.field521[var29], var26, var28);
                     if (var15.interactType != 0) {
                        var14.method3749(var2, var3, var6, var5, var15.boolean1);
                     }
                  } else if (var6 == 3) {
                     if (var15.animationId == -1 && var15.transforms == null) {
                        ...
                        var36 = new DynamicObject(var4, 3, var5, var12, var2, var3, var15.animationId, var15.field3429, (Entity)null);
                     }
                     ...
                     if (var15.animationId == -1 && var15.transforms == null) {
                        ...
                        var36 = new DynamicObject(var4, 4, var5, var12, var2, var3, var15.animationId, var15.field3429, (Entity)null);
                     }

                     var41.newWallDecoration(var0, var2, var3, var23, (Entity)var36, (Entity)null, Tiles.field521[var5], 0, 0, 0, var26, var28);
                  } else {
                     long var30;
                     Object var32;
                     if (var6 == 5) {
                        ...
                        if (var15.animationId == -1 && var15.transforms == null) {
                           ...
                           var32 = new DynamicObject(var4, 4, var5, var12, var2, var3, var15.animationId, var15.field3429, (Entity)null);
                        }

                        var41.newWallDecoration(var0, var2, var3, var23, (Entity)var32, (Entity)null, Tiles.field521[var5], 0, var29 * Tiles.field523[var5], var29 * Tiles.field527[var5], var26, var28);
                     } else if (var6 == 6) {
                        var29 = 8;
                        var30 = var41.getBoundaryObjectTag(var0, var2, var3);
                        if (var30 != 0L) {
                        ...
                        if (var15.animationId == -1 && var15.transforms == null) {
                           ...
                           var32 = new DynamicObject(var4, 4, var5 + 4, var12, var2, var3, var15.animationId, var15.field3429, (Entity)null);
                        }

                        var41.newWallDecoration(var0, var2, var3, var23, (Entity)var32, (Entity)null, 256, var5, var29 * Tiles.field525[var5], var29 * Tiles.field526[var5], var26, var28);
                     } else if (var6 == 7) {
                        int var35 = var5 + 2 & 3;
                        if (var15.animationId == -1 && var15.transforms == null) {
                           var36 = var15.getModel(4, var35 + 4, var22, var24, var23, var25);
                        } else {
                           var36 = new DynamicObject(var4, 4, var35 + 4, var12, var2, var3, var15.animationId, var15.field3429, (Entity)null);
                        }

                        var41.newWallDecoration(var0, var2, var3, var23, (Entity)var36, (Entity)null, 256, var35, 0, 0, var26, var28);
                     } else if (var6 == 8) {
                        var29 = 8;
                        var30 = var41.getBoundaryObjectTag(var0, var2, var3);
                        if (var30 != 0L) {
                        ...
                        if (var15.animationId == -1 && var15.transforms == null) {
                           ...
                           var32 = new DynamicObject(var4, 4, var5 + 4, var12, var2, var3, var15.animationId, var15.field3429, (Entity)null);
                           var33 = new DynamicObject(var4, 4, var34 + 4, var12, var2, var3, var15.animationId, var15.field3429, (Entity)null);
                        }

                        var41.newWallDecoration(var0, var2, var3, var23, (Entity)var32, (Entity)var33, 256, var5, var29 * Tiles.field525[var5], var29 * Tiles.field526[var5], var26, var28);
                     }
                  }
               }
            } else {
               if (var15.animationId == -1 && var15.transforms == null) {
                  ...
                  var36 = new DynamicObject(var4, 10, var5, var12, var2, var3, var15.animationId, var15.field3429, (Entity)null);
               }

               if (var36 != null) {
                  var41.method3400(var0, var2, var3, var23, var16, var17, (Entity)var36, var6 == 11 ? 256 : 0, var26, var28);
               }
