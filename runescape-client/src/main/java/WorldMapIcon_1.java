...
public class WorldMapIcon_1 extends AbstractWorldMapIcon {
   ...
   public static void method377(int var0, int var1) {
      VarbitDefinition var2 = Tiles.method1219(var0);
                  ...
                  while(true) {
                     while(!var12) {
                        ...
                        if (var17 > 0 && var18 > 0 && var17 < 103 && var18 < 103) {
                           ObjectDefinition var53 = WorldMapAreaData.getObjectDefinition(var9);
         ...
         if (!var0) {
            ...
            for(ObjectSound var54 = (ObjectSound)ObjectSound.objectSounds.last(); var54 != null; var54 = (ObjectSound)ObjectSound.objectSounds.previous()) {
               if (var54.stream1 != null) {
                  VarbitDefinition.pcmStreamMixer.removeSubStream(var54.stream1);
                  var54.stream1 = null;
               }

               if (var54.stream2 != null) {
                  VarbitDefinition.pcmStreamMixer.removeSubStream(var54.stream2);
                  var54.stream2 = null;
               }
            }
                     ...
                     while(true) {
                        ...
                        while(true) {
                           ...
                           if (var19 > 0 && var20 > 0 && var19 < 103 && var20 < 103) {
                              ...
                              GameShell.method1134(var15, var19, var20, var9, var18, var17, var49, var52);
                           }
                        }
                     }
                  }
