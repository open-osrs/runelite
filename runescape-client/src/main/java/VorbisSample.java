...
public class VorbisSample extends Node {
	...
	void read(byte[] var1) {
		...
		this.field370 = new byte[var3][]; // L: 99
	...
	float[] method1015(int var1) {
		VorbisSample_setData(this.field370[var1], 0); // L: 198
		readBit(); // L: 199
		int var2 = readBits(class326.iLog(VorbisSample_mapping.length - 1)); // L: 200
		...
		for (var17 = 0; var17 < var14.submaps; ++var17) { // L: 244
			...
			float[] var44 = field385; // L: 246
			var42.method807(var44, var4 >> 1, var45); // L: 247
		}
		...
		if (!var15) { // L: 250
			...
			VorbisSample_floors[var18].method700(field385, var4 >> 1); // L: 253
		}
		...
		if (var15) { // L: 256
			...
			float[] var40 = var3 ? field389 : field390; // L: 266
			float[] var22 = var3 ? field376 : field392; // L: 267
			float[] var23 = var3 ? field391 : field395; // L: 268
			int[] var24 = var3 ? field367 : field373; // L: 269
			...
			var25 = class326.iLog(var4 - 1); // L: 290
			...
			for (var46 = var11; var46 < var12; ++var46) { // L: 365
				...
				var10000 = field385; // L: 367
				var10000[var46] *= (float)Math.sin(1.5707963267948966D * (double)var27 * (double)var27);
			}
		}

		float[] var41 = null; // L: 370
		if (this.field382 > 0) { // L: 371
			var18 = var4 + this.field382 >> 2; // L: 372
			var41 = new float[var18]; // L: 373
			int var43;
			if (!this.field384) { // L: 374
				for (var19 = 0; var19 < this.field383; ++var19) { // L: 375
					var43 = var19 + (this.field382 >> 1); // L: 376
					var41[var19] += this.field381[var43]; // L: 377
				}
			}
			...
			if (!var15) { // L: 380
				for (var19 = var8; var19 < var4 >> 1; ++var19) { // L: 381
					...
					var41[var43] += field385[var19]; // L: 383
				}
			}
		}

		float[] var54 = this.field381; // L: 387
		this.field381 = field385; // L: 388
		field385 = var54; // L: 389
		this.field382 = var4; // L: 390
		this.field383 = var12 - (var4 >> 1); // L: 391
		this.field384 = var15; // L: 392
		return var41; // L: 393
	}
	...
	RawSound toRawSound(int[] var1) {
		if (var1 != null && var1[0] <= 0) { // L: 421
			...
			if (this.samples == null) { // L: 422
				this.field382 = 0; // L: 423
				this.field381 = new float[VorbisSample_blockSize1]; // L: 424
				this.samples = new byte[this.sampleCount]; // L: 425
				this.field393 = 0; // L: 426
				this.field386 = 0; // L: 427
			}

			for (; this.field386 < this.field370.length; ++this.field386) { // L: 429 444
				if (var1 != null && var1[0] <= 0) { // L: 430
					return null;
				}

				float[] var2 = this.method1015(this.field386); // L: 431
				if (var2 != null) { // L: 432
			...
			this.field381 = null; // L: 446
			byte[] var7 = this.samples; // L: 447
			this.samples = null; // L: 448
			return new RawSound(this.sampleRate, var7, this.start, this.end, this.field368); // L: 449
		}
	}
	...
	static void method1011(byte[] var0) {
		...
		field385 = new float[VorbisSample_blockSize1]; // L: 117
		...
		for (var1 = 0; var1 < 2; ++var1) { // L: 118
			...
			int var10 = class326.iLog(var5 - 1); // L: 139
			...
			if (var1 != 0) { // L: 157
				field389 = var18; // L: 158
				field376 = var19; // L: 159
				field391 = var20; // L: 160
				field367 = var21; // L: 161
			} else {
				field390 = var18; // L: 164
				field392 = var19; // L: 165
				field395 = var20; // L: 166
				field373 = var21; // L: 167
			}
		}
