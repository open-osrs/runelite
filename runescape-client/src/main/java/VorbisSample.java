...
public class VorbisSample extends Node {
	...
	void read(byte[] var1) {
		...
		if (this.end < 0) { // L: 94
			...
			this.field486 = true; // L: 96
		}

		int var3 = var2.readInt(); // L: 98
		this.field487 = new byte[var3][]; // L: 99
	...
	float[] method1058(int var1) {
		VorbisSample_setData(this.field487[var1], 0); // L: 182
		readBit(); // L: 183
		int var2 = readBits(class10.iLog(VorbisSample_mapping.length - 1)); // L: 184
		...
		for (var17 = 0; var17 < var14.submaps; ++var17) { // L: 228
			...
			float[] var44 = field481; // L: 230
			var42.method877(var44, var4 >> 1, var45); // L: 231
		}
		...
		if (!var15) { // L: 234
			...
			VorbisSample_floors[var18].method779(field481, var4 >> 1); // L: 237
		}
		...
		if (var15) { // L: 240
			...
			float[] var40 = var3 ? field507 : field496; // L: 250
			float[] var22 = var3 ? field489 : field505; // L: 251
			float[] var23 = var3 ? field509 : field508; // L: 252
			int[] var24 = var3 ? field511 : field510; // L: 253
			...
			var25 = class10.iLog(var4 - 1); // L: 274
			...
			for (var46 = var11; var46 < var12; ++var46) { // L: 349
				...
				var10000 = field481; // L: 351
				var10000[var46] *= (float)Math.sin(1.5707963267948966D * (double)var27 * (double)var27);
			}
		}

		float[] var41 = null; // L: 354
		if (this.field500 > 0) { // L: 355
			var18 = var4 + this.field500 >> 2; // L: 356
			var41 = new float[var18]; // L: 357
			int var43;
			if (!this.field484) { // L: 358
				for (var19 = 0; var19 < this.field494; ++var19) { // L: 359
					var43 = var19 + (this.field500 >> 1); // L: 360
					var41[var19] += this.field499[var43]; // L: 361
				}
			}
			...
			if (!var15) { // L: 364
				for (var19 = var8; var19 < var4 >> 1; ++var19) { // L: 365
					...
					var41[var43] += field481[var19]; // L: 367
				}
			}
		}

		float[] var54 = this.field499; // L: 371
		this.field499 = field481; // L: 372
		field481 = var54; // L: 373
		this.field500 = var4; // L: 374
		this.field494 = var12 - (var4 >> 1); // L: 375
		this.field484 = var15; // L: 376
		return var41; // L: 377
	}
	...
	RawSound toRawSound(int[] var1) {
		if (var1 != null && var1[0] <= 0) { // L: 405
			...
			if (this.samples == null) { // L: 406
				this.field500 = 0; // L: 407
				this.field499 = new float[VorbisSample_blockSize1]; // L: 408
				this.samples = new byte[this.sampleCount]; // L: 409
				this.field497 = 0; // L: 410
				this.field514 = 0; // L: 411
			}

			for (; this.field514 < this.field487.length; ++this.field514) { // L: 413 428
				if (var1 != null && var1[0] <= 0) { // L: 414
					return null;
				}

				float[] var2 = this.method1058(this.field514); // L: 415
				if (var2 != null) { // L: 416
					int var3 = this.field497; // L: 417
					...
					this.field497 = var3; // L: 426
				}
			}

			this.field499 = null; // L: 430
			byte[] var7 = this.samples; // L: 431
			this.samples = null; // L: 432
			return new RawSound(this.sampleRate, var7, this.start, this.end, this.field486); // L: 433
		}
	}
	...
	static void method1064(byte[] var0) {
		...
		field481 = new float[VorbisSample_blockSize1]; // L: 117
		...
		for (var1 = 0; var1 < 2; ++var1) { // L: 118
			...
			int var10 = class10.iLog(var5 - 1); // L: 139
			...
			if (var1 != 0) { // L: 141
				field507 = var12; // L: 142
				field489 = var13; // L: 143
				field509 = var14; // L: 144
				field511 = var15; // L: 145
			} else {
				field496 = var12; // L: 148
				field505 = var13; // L: 149
				field508 = var14; // L: 150
				field510 = var15; // L: 151
			}
		}
