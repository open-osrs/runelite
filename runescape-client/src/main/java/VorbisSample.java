...
public class VorbisSample extends Node {
	...
	float[] method2425(int var1) {
		...
		for (var17 = 0; var17 < var14.submaps; ++var17) {
			...
			float[] var44 = field1392;
			var42.method2586(var44, var4 >> 1, var45);
		}
		...
		if (!var15) {
			...
			VorbisSample_floors[var18].method2465(field1392, var4 >> 1);
		}
		...
		if (var15) {
			...
			float[] var40 = var3 ? field1396 : field1393;
		...
		float[] var41 = null;
		if (this.field1389 > 0) {
			var18 = var4 + this.field1389 >> 2;
			var41 = new float[var18];
			int var43;
			if (!this.field1377) {
				for (var19 = 0; var19 < this.field1390; ++var19) {
					var43 = var19 + (this.field1389 >> 1);
					var41[var19] += this.field1388[var43];
				}
			}
