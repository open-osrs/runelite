...
public abstract class GameShell extends Applet implements Runnable, FocusListener, WindowListener {
   ...
   @ObfuscatedName("ak")
   volatile boolean field468 = true;
   @ObfuscatedName("al")
   ...
   static final void method1134(int var0, int var1, int var2, int var3, int var4, int var5, Scene var6, CollisionMap var7) {
      if (!Client.isLowDetail || (Tiles.Tiles_renderFlags[0][var1][var2] & 2) != 0 || (Tiles.Tiles_renderFlags[var0][var1][var2] & 16) == 0) {
         ...
         ObjectDefinition var8 = WorldMapAreaData.getObjectDefinition(var3);
         int var9;
         int var10;
         if (var4 != 1 && var4 != 3) {
            var9 = var8.sizeX;
         ...
         if (var5 == 22) {
            ...
            if (var5 >= 12) {
               ...
               var6.method3400(var0, var1, var2, var16, 1, 1, (Entity)var34, 0, var19, var21);
               ...
               var6.newBoundaryObject(var0, var1, var2, var16, (Entity)var34, (Entity)null, Tiles.field521[var4], 0, var19, var21);
               if (var4 == 0) {
                  if (var8.clipped) {
               ...
               var6.newBoundaryObject(var0, var1, var2, var16, (Entity)var34, (Entity)null, Tiles.field514[var4], 0, var19, var21);
               if (var8.clipped) {
                  if (var4 == 0) {
                     TaskHandler.field2045[var0][var1][var2 + 1] = 50;
                  } else if (var4 == 1) {
               ...
               if (var5 == 2) {
                  ...
                  var6.newBoundaryObject(var0, var1, var2, var16, (Entity)var31, (Entity)var32, Tiles.field521[var4], Tiles.field521[var28], var19, var21);
                  if (var8.modelClipped) {
                     if (var4 == 0) {
                        class2.field12[var0][var1][var2] |= 585;
                        class2.field12[var0][var1][var2 + 1] |= 1170;
                  ...
                  var6.newWallDecoration(var0, var1, var2, var16, (Entity)var34, (Entity)null, Tiles.field521[var4], 0, 0, 0, var19, var21);
               } else {
                  Object var25;
                  long var29;
                  if (var5 == 5) {
                     ...
                     var6.newWallDecoration(var0, var1, var2, var16, (Entity)var25, (Entity)null, Tiles.field521[var4], 0, var28 * Tiles.field523[var4], var28 * Tiles.field527[var4], var19, var21);
                  } else if (var5 == 6) {
                     var28 = 8;
                     var29 = var6.getBoundaryObjectTag(var0, var1, var2);
                     if (0L != var29) {
                     ...
                     var6.newWallDecoration(var0, var1, var2, var16, (Entity)var25, (Entity)null, 256, var4, var28 * Tiles.field525[var4], var28 * Tiles.field526[var4], var19, var21);
                  } else if (var5 == 7) {
                     var23 = var4 + 2 & 3;
                     if (var8.animationId == -1 && var8.transforms == null) {
                     ...
                     var6.newWallDecoration(var0, var1, var2, var16, (Entity)var25, (Entity)var26, 256, var4, var28 * Tiles.field525[var4], var28 * Tiles.field526[var4], var19, var21);
                  }
               }
            }
         } else {
            ...
            if (var34 != null && var6.method3400(var0, var1, var2, var16, var9, var10, (Entity)var34, var5 == 11 ? 256 : 0, var19, var21) && var8.clipped) {
               var23 = 15;
   ...
   static void load() {
      ...
      if (Client.titleLoadingStage == 0) {
         ...
         GrandExchangeOfferAgeComparator.sceneMinimapSprite = new Sprite(512, 512);
         ...
         PlayerAppearance.archive3 = ViewportMouse.newArchive(3, false, true, true);
         ...
         ItemDefinition.archive17 = ViewportMouse.newArchive(17, true, true, true);
         ...
         var14 += PlayerAppearance.archive3.percentage() * 2 / 100;
         ...
         var14 += ItemDefinition.archive17.method4461() && ItemDefinition.archive17.isFullyLoaded() ? 1 : 0;
         if (var14 != 100) {
            if (var14 != 0) {
            ...
            class60.spriteIds.decode(ItemDefinition.archive17);
         ...
         VarbitDefinition.pcmStreamMixer = new PcmStreamMixer();
         WorldMapDecorationType.pcmPlayer1.setStream(VarbitDefinition.pcmStreamMixer);
         ...
         if (Client.titleLoadingStage == 50) {
            ...
            if (Client.titleLoadingStage == 60) {
               ...
               if (!WorldMapIcon_0.archive2.isFullyLoaded()) {
                  ...
                  ItemDefinition.ItemDefinition_fontPlain11 = var17;
                  ...
                  VarbitDefinition.VarbitDefinition_archive = var7;
                  ...
                  MouseHandler.method1151(PlayerAppearance.archive3, WorldMapData_0.archive7, ModeWhere.archive8, CollisionMap.archive13);
               ...
               if (!PlayerAppearance.archive3.isFullyLoaded()) {
                  Login.Login_loadingText = "Loading interfaces - " + PlayerAppearance.archive3.loadPercent() * 4 / 5 + "%";
