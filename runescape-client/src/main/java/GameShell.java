...
public abstract class GameShell extends Applet implements Runnable, FocusListener, WindowListener {
	...
	final void resizeCanvas() {
		...
		if (var1 != null) {
			...
			this.contentWidth = Math.max(var2.highX, this.contentWidth0);
			this.contentHeight = Math.max(var2.highY, this.contentHeight0);
	...
	static void updateGameState(int gameState) {
		if (gameState != Client.gameState) {
			...
			if (gameState != 5 && gameState != 10) {
				if (gameState == 20) {
					class2.method27(class16.archive10, WorldMapSection2.archive8, true, Client.gameState == 11 ? 4 : 0);
				} else if (gameState == 11) {
					class2.method27(class16.archive10, WorldMapSection2.archive8, false, 4);
				} else {
					class80.method2015();
				}
			} else {
				class2.method27(class16.archive10, WorldMapSection2.archive8, true, 0);
			}
