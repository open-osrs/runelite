...
public class DynamicObject extends Entity {
      ...
      protected final Model getModel() {
            ...
            ObjectDefinition var12 = GrandExchangeOfferOwnWorldComparator.getObjectDefinition(this.field_16);
            ...
            if (var12 == null) {
                  ...
                  int var4 = (var2 >> 1) + this.field_17;
                  int var5 = (var2 + 1 >> 1) + this.field_17;
                  int var6 = (var3 >> 1) + this.field_18;
                  int var7 = (var3 + 1 >> 1) + this.field_18;
                  int[][] var8 = Tiles.Tiles_heights[this.plane];
                  int var9 = var8[var5][var6] + var8[var4][var6] + var8[var4][var7] + var8[var5][var7] >> 2;
                  int var10 = (this.field_17 << 7) + (var2 << 6);
                  int var11 = (this.field_18 << 7) + (var3 << 6);
            ...
            for(Projectile var0 = (Projectile)Client.projectiles.last(); var0 != null; var0 = (Projectile)Client.projectiles.previous()) {
                  if (var0.plane == WorldMapRectangle.plane && Client.cycle <= var0.cycleEnd) {
                        if (Client.cycle >= var0.cycleStart) {
                              ...
                              PacketWriter.scene.drawEntity(WorldMapRectangle.plane, (int)var0.field_20, (int)var0.field_21, (int)var0.field_22, 60, var0, var0.yaw, -1L, false);
                        }
                  } else {
                        var0.remove();
                  }
