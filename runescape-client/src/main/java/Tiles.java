...
public final class Tiles {
      ...
      static int[][][] field488;
      @ObfuscatedName("x")
      static final int[] field489 = new int[]{1, 2, 4, 8};
      @ObfuscatedName("h")
      static final int[] field493 = new int[]{16, 32, 64, 128};
      @ObfuscatedName("s")
      static final int[] field491 = new int[]{1, 0, -1, 0};
      @ObfuscatedName("f")
      static final int[] field492 = new int[]{0, -1, 0, 1};
      @ObfuscatedName("j")
      static final int[] field484 = new int[]{1, -1, -1, 1};
      @ObfuscatedName("d")
      static final int[] field494 = new int[]{-1, -1, 1, 1};
      @ObfuscatedName("l")
      @ObfuscatedGetter(
            intValue = 832386391
      )
      static int field482 = (int)(Math.random() * 17.0D) - 8;
      @ObfuscatedName("k")
      @ObfuscatedGetter(
            intValue = 1017991539
      )
      static int field496 = (int)(Math.random() * 33.0D) - 16;
      @ObfuscatedName("fy")
      @ObfuscatedGetter(
