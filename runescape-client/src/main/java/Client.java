...
public final class Client extends GameShell implements Usernamed {
      ...
      protected final void setUp() {
            ...
            HitSplatDefinition.port1 = gameBuild == 0 ? 'ꩊ' : worldId + '鱀';
            BZip2State.port2 = gameBuild == 0 ? 443 : worldId + '썐';
                        ...
                        while(true) {
                              ...
                              if (!var29) {
                                    ...
                                    synchronized(WorldMapLabel.mouseRecorder.lock) {
                                          if (!field802) {
                                                ...
                                                for(var7 = 0; var7 < WorldMapLabel.mouseRecorder.index && (var30 == null || var30.packetBuffer.offset - var3 < 246); ++var7) {
                                                      var4 = var7;
                                                      var8 = WorldMapLabel.mouseRecorder.field_32[var7];
                                                      if (var8 < -1) {
                                                            var8 = -1;
                                                      } else if (var8 > 65534) {
                                                            var8 = 65534;
                                                      ...
                                                      var9 = WorldMapLabel.mouseRecorder.field_31[var7];
                                                      if (var9 < -1) {
                                                            var9 = -1;
                                                      } else if (var9 > 65534) {
                                                            var9 = 65534;
                                                ...
                                                if (var4 >= WorldMapLabel.mouseRecorder.index) {
                                                      ...
                                                      System.arraycopy(WorldMapLabel.mouseRecorder.field_31, var4, WorldMapLabel.mouseRecorder.field_31, 0, WorldMapLabel.mouseRecorder.index);
                                                      System.arraycopy(WorldMapLabel.mouseRecorder.field_32, var4, WorldMapLabel.mouseRecorder.field_32, 0, WorldMapLabel.mouseRecorder.index);
                                    ...
                                    while(true) {
                                          ...
                                          ScriptEvent var41;
                                          do {
                                                var41 = (ScriptEvent)field836.removeLast();
                                                if (var41 == null) {
                                                      while(true) {
                                                            do {
                                                                  var41 = (ScriptEvent)field763.removeLast();
                                                                  if (var41 == null) {
                                                                        while(true) {
                                                                              do {
                                                                                    ...
                                                                                    if (var41 == null) {
                                                                                                ...
                                                                                                if (MouseHandler.MouseHandler_currentButton == 0) {
                                                                                                      if (field748) {
                                                                                                            if (Frames.dragInventoryWidget == DevicePcmPlayerProvider.field391 && dragItemSlotDestination != dragItemSlotSource) {
                                                                                                                  ...
                                                                                                                  byte var33 = 0;
                                                                                                                  if (field873 == 1 && var42.contentType == 206) {
                                                                                                                        var33 = 1;
                                                                                                                  }
                                                                                                                  ...
                                                                                                                  if (WorldMapSection0.method249(class2.getWidgetClickMask(var42))) {
                                                                                          ...
                                                                                          if (var38 != NetSocket.mousedOverWidgetIf1) {
                                                                                                if (var38 != null) {
                                                                                                      WorldMapSectionType.invalidateWidget(var38);
                                                                                                }
                                                                              ...
                                                                              ParamDefinition.runScriptEvent(var41);
                                                                        }
                                                                  }
            ...
            if (var2 == null) {
                  ...
                  try {
                        ...
                        if (ServerPacket.field2166 == var1.serverPacket) {
                              ...
                              if (var20 != null) {
                                    WorldMapSectionType.invalidateWidget(var20);
                                    GameShell.revalidateWidgetScroll(UserComparator5.Widget_interfaceComponents[var20.field_9 >>> 16], var20, true);
                              }
                        ...
                        if (ServerPacket.field2160 == var1.serverPacket) {
                              ...
                              for(PendingSpawn var37 = (PendingSpawn)pendingSpawns.last(); var37 != null; var37 = (PendingSpawn)pendingSpawns.previous()) {
                                    if (var37.field_4 >= class40.field326 && var37.field_4 < class40.field326 + 8 && var37.field_5 >= WorldMapSection2.field195 && var37.field_5 < WorldMapSection2.field195 + 8 && var37.plane == WorldMapRectangle.plane) {
                                          var37.hitpoints = 0;
                                    }
                              }
