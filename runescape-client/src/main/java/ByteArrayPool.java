   ...
   static synchronized byte[] ByteArrayPool_get(int var0, boolean var1) {
      ...
      if (RouteStrategy.field760 != null) {
         for (int var3 = 0; var3 < field55.length; ++var3) {
            ...
            } else if (WorldMapSection1.field1082[var3] > 0) {
               byte[] var4 = RouteStrategy.field760[var3][--WorldMapSection1.field1082[var3]];
               RouteStrategy.field760[var3][WorldMapSection1.field1082[var3]] = null;
               return var4;
            }
         }
      }
