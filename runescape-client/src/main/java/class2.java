...
final class class2 implements class0 {
	...
	static void method27(AbstractArchive var0, AbstractArchive var1, boolean var2, int var3) {
		if (Login.field465) {
			...
			Login.leftTitleSprite = WorldMapSprite.convertJpgToSprite(var4);
			...
			IndexedSprite[] var7;
			if (!SpriteMask.SpriteBuffer_loadSprite(var1, var5, var6)) {
				var7 = null;
			} else {
				var7 = WorldMapLabel.SpriteBuffer_createIndexedSpriteArray();
			}
			...
			IndexedSprite[] var9;
			if (!SpriteMask.SpriteBuffer_loadSprite(var1, var6, var8)) {
				var9 = null;
			} else {
				var9 = WorldMapLabel.SpriteBuffer_createIndexedSpriteArray();
			}
	...
	public static Sprite[] method20(AbstractArchive var0, String var1, String var2) {
		...
		Sprite[] var5;
		if (!SpriteMask.SpriteBuffer_loadSprite(var0, var3, var4)) {
			var5 = null;
		} else {
			var5 = UserComparator9.SpriteBuffer_createSpriteArray();
		}
