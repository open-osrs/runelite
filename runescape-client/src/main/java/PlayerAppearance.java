...
public class PlayerAppearance {
		...
		if (equipment == null) {
			...
			for (int var5 = 0; var5 < 7; ++var5) {
				for (int var6 = 0; var6 < KitDefinition.KitDefinition_fileCount; ++var6) {
					KitDefinition var7 = WorldMapSection3.getKitDefinition(var6);
				...
				do {
					do {
						do {
							...
							var4 = WorldMapSection3.getKitDefinition(var3);
						} while(var4 == null);
	...
	public Model getModel(SequenceDefinition var1, int var2, SequenceDefinition var3, int var4) {
		...
		if (var15 == null) {
			...
			for (int var11 = 0; var11 < 12; ++var11) {
				var10 = var7[var11];
				if (var10 >= 256 && var10 < 512 && !WorldMapSection3.getKitDefinition(var10 - 256).ready()) {
					var9 = true;
				}
			...
			if (var15 == null) {
				...
				for (int var13 = 0; var13 < 12; ++var13) {
					...
					if (var12 >= 256 && var12 < 512) {
						var14 = WorldMapSection3.getKitDefinition(var12 - 256).getModelData();
						if (var14 != null) {
							var17[var10++] = var14;
						}
					}
	...
	ModelData getModelData() {
		...
		for (int var3 = 0; var3 < 12; ++var3) {
			...
			if (var2 >= 256 && var2 < 512 && !WorldMapSection3.getKitDefinition(var2 - 256).method161()) {
				var1 = true;
			}
		...
		for (int var5 = 0; var5 < 12; ++var5) {
			...
			if (var4 >= 256 && var4 < 512) {
				var6 = WorldMapSection3.getKitDefinition(var4 - 256).method162();
				if (var6 != null) {
					var7[var2++] = var6;
				}
			}
