...
public class PlayerAppearance {
      ...
      public int getChatHeadId() {
            return this.npcTransformId == -1 ? (this.equipment[0] << 15) + this.equipment[1] + (this.equipment[11] << 5) + (this.equipment[8] << 10) + (this.bodyColors[0] << 25) + (this.bodyColors[4] << 20) : 305419896 + PacketBufferNode.getNpcDefinition(this.npcTransformId).field_13;
      }
      ...
      public static boolean method3998() {
            long var0 = class30.currentTimeMs();
                                    ...
                                    if (var5 > 0) {
                                          ...
                                          if (NetCache.field3156 != 0) {
                                                for(var7 = 0; var7 < var6; ++var7) {
                                                      NetCache.NetCache_responseHeaderBuffer.array[NetCache.NetCache_responseHeaderBuffer.offset + var7] ^= NetCache.field3156;
                                                }
                                          }
                                          ...
                                          if (NetCache.field3156 != 0) {
                                                for(var8 = 0; var8 < var7; ++var8) {
                                                      FaceNormal.NetCache_responseArchiveBuffer.array[var8 + FaceNormal.NetCache_responseArchiveBuffer.offset] ^= NetCache.field3156;
                                                }
                                          }
