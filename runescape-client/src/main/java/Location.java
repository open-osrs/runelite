...
public class Location {
	...
	static final Location field2370;
	@ObfuscatedName("t")
	@ObfuscatedSignature(
		signature = "Lgx;"
	)
	static final Location field2368;
	@ObfuscatedName("o")
	@ObfuscatedSignature(
		signature = "Lgx;"
	)
	static final Location field2373;

	static {
		field2370 = new Location();
		field2368 = new Location();
		field2373 = new Location();
	}
		...
		if (LocationSet.localPlayer != var0) {
			if (Client.menuOptionsCount < 400) {
				...
				if (var0.skillLevel == 0) {
					...
					int var8 = LocationSet.localPlayer.combatLevel;
					int var9 = var8 - var7;
					String var6;
					if (var9 < -9) {
					...
					for (var10 = 7; var10 >= 0; --var10) {
						if (Client.playerMenuActions[var10] != null) {
							...
							if (Client.playerMenuActions[var10].equalsIgnoreCase("Attack")) {
								...
								if (Client.playerAttackOption == AttackOption.AttackOption_alwaysRightClick || Client.playerAttackOption == AttackOption.AttackOption_dependsOnCombatLevels && var0.combatLevel > LocationSet.localPlayer.combatLevel) {
									var11 = 2000;
								}

								if (LocationSet.localPlayer.team != 0 && var0.team != 0) {
									if (var0.team == LocationSet.localPlayer.team) {
										var11 = 2000;
									} else {
										var11 = 0;
									}
