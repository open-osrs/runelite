...
public enum Menus
{
	...
	// This should cover all cases of using poison, probably could have shortened some words / used ID's but it's better to be more strict than less strict
	USE_MEAT_FIGHTER(Role.HEALER, new ComparableEntry("use", "poisoned meat -> penance fighter", -1, MenuAction.ITEM_USE_ON_NPC.getId(), true, false)),
	USE_MEAT_GAME(Role.HEALER, new ComparableEntry("use", "poisoned meat ->", -1, MenuAction.ITEM_USE_ON_GAME_OBJECT.getId(), true, false)),
	USE_MEAT_GROUND(Role.HEALER, new ComparableEntry("use", "poisoned meat ->", -1, MenuAction.ITEM_USE_ON_GROUND_ITEM.getId(), true, false)),
	USE_MEAT_HEALER(Role.HEALER, new ComparableEntry("use", "poisoned meat -> penance healer", -1, MenuAction.ITEM_USE_ON_NPC.getId(), true, false)),
	USE_MEAT_ITEM(Role.HEALER, new ComparableEntry("use", "poisoned meat ->", -1, MenuAction.ITEM_USE_ON_WIDGET_ITEM.getId(), true, false)),
	USE_MEAT_PLAYER(Role.HEALER, new ComparableEntry("use", "poisoned meat ->", -1, MenuAction.ITEM_USE_ON_PLAYER.getId(), true, false)),
	USE_MEAT_RANGER(Role.HEALER, new ComparableEntry("use", "poisoned meat -> penance ranger", -1, MenuAction.ITEM_USE_ON_NPC.getId(), true, false)),
	USE_MEAT_RUNNER(Role.HEALER, new ComparableEntry("use", "poisoned meat -> penance runner", -1, MenuAction.ITEM_USE_ON_NPC.getId(), true, false)),
	USE_MEAT_WIDGET(Role.HEALER, new ComparableEntry("use", "poisoned meat ->", -1, MenuAction.ITEM_USE_ON_WIDGET.getId(), true, false)),
	USE_TOFU_FIGHTER(Role.HEALER, new ComparableEntry("use", "poisoned tofu -> penance fighter", -1, MenuAction.ITEM_USE_ON_NPC.getId(), true, false)),
	USE_TOFU_GAME(Role.HEALER, new ComparableEntry("use", "poisoned tofu ->", -1, MenuAction.ITEM_USE_ON_GAME_OBJECT.getId(), true, false)),
	USE_TOFU_GROUND(Role.HEALER, new ComparableEntry("use", "poisoned tofu ->", -1, MenuAction.ITEM_USE_ON_GROUND_ITEM.getId(), true, false)),
	USE_TOFU_HEALER(Role.HEALER, new ComparableEntry("use", "poisoned tofu -> penance healer", -1, MenuAction.ITEM_USE_ON_NPC.getId(), true, false)),
	USE_TOFU_ITEM(Role.HEALER, new ComparableEntry("use", "poisoned tofu ->", -1, MenuAction.ITEM_USE_ON_WIDGET_ITEM.getId(), true, false)),
	USE_TOFU_PLAYER(Role.HEALER, new ComparableEntry("use", "poisoned tofu ->", -1, MenuAction.ITEM_USE_ON_PLAYER.getId(), true, false)),
	USE_TOFU_RANGER(Role.HEALER, new ComparableEntry("use", "poisoned tofu -> penance ranger", -1, MenuAction.ITEM_USE_ON_NPC.getId(), true, false)),
	USE_TOFU_RUNNER(Role.HEALER, new ComparableEntry("use", "poisoned tofu -> penance runner", -1, MenuAction.ITEM_USE_ON_NPC.getId(), true, false)),
	USE_TOFU_WIDGET(Role.HEALER, new ComparableEntry("use", "poisoned tofu ->", -1, MenuAction.ITEM_USE_ON_WIDGET.getId(), true, false)),
	...
	USE_WORMS_FIGHTER(Role.HEALER, new ComparableEntry("use", "poisoned worms -> penance fighter", -1, MenuAction.ITEM_USE_ON_NPC.getId(), true, false)),
	USE_WORMS_GAME(Role.HEALER, new ComparableEntry("use", "poisoned worms ->", -1, MenuAction.ITEM_USE_ON_GAME_OBJECT.getId(), true, false)),
	USE_WORMS_GROUND(Role.HEALER, new ComparableEntry("use", "poisoned worms ->", -1, MenuAction.ITEM_USE_ON_GROUND_ITEM.getId(), true, false)),
	USE_WORMS_HEALER(Role.HEALER, new ComparableEntry("use", "poisoned worms -> penance healer", -1, MenuAction.ITEM_USE_ON_NPC.getId(), true, false)),
	USE_WORMS_ITEM(Role.HEALER, new ComparableEntry("use", "poisoned worms ->", -1, MenuAction.ITEM_USE_ON_WIDGET_ITEM.getId(), true, false)),
	USE_WORMS_PLAYER(Role.HEALER, new ComparableEntry("use", "poisoned worms ->", -1, MenuAction.ITEM_USE_ON_PLAYER.getId(), true, false)),
	USE_WORMS_RANGER(Role.HEALER, new ComparableEntry("use", "poisoned worms -> penance ranger", -1, MenuAction.ITEM_USE_ON_NPC.getId(), true, false)),
	USE_WORMS_RUNNER(Role.HEALER, new ComparableEntry("use", "poisoned worms -> penance runner", -1, MenuAction.ITEM_USE_ON_NPC.getId(), true, false)),
	USE_WORMS_WIDGET(Role.HEALER, new ComparableEntry("use", "poisoned worms ->", -1, MenuAction.ITEM_USE_ON_WIDGET.getId(), true, false)),
